...
%logos
\vfill
\ifdef{\logo}{\IfFileExists{\logo}{\hfill\includegraphics[width=3cm]{./logos.png}\hfill\logoum{}\\ São Paulo\_\the\year}}{\includegraphics[width=6.5cm]{./logos.png}\break{} São Paulo\_\the\year}
