...
%logos
\vfill
\ifdef{\logo}{\IfFileExists{\logo}{\hfill\includegraphics[width=3cm]{./logos.pdf}\hfill\logoum{}\\ São Paulo\_\the\year}}{\includegraphics[width=6.5cm]{./logos.pdf}\break{} São Paulo\quad\the\year}
