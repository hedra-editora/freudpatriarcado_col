...
\item
  \textbf{Aquém do pai? Sexuação, socialização e fraternidade em
...
Pedro Ambra\footnote{Psicanalista, doutor pela Universidade de São Paulo
...
Voltemos ao texto ``Sobre alguns mecanismos''\emph{.} Logo no início,
...
\textbf{O patriarcado e a expulsão}
...
\def\labelenumi{\arabic{enumi})}
\item
  \textbf{Vulnerabilidade fundamental}
\end{enumerate}
