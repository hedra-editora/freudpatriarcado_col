\textbf{II. Interstícios do texto freudiano: acerto de contas}

\textbf{3) Dentro do sonho}\footnote{Este capítulo é uma adaptação do
  Capítulo 3 da obra de Stephen Frosh, \emph{Diferença Sexual:
  Masculinidade e psicanálise}. Londres: Routledge, 1994.}

Stephen Frosh

\textbf{As origens da psicanálise}
...
\textbf{Identificações masculinas: de José a Moisés}
...
{[}...{]}. Meu Eu pode se esconder facilmente por trás das pessoas que
...
\textbf{O sonho da injeção de Irma}
...
\begin{quote}
{[}...{]} como é que Freud, ele que vai mais adiante desenvolver a
...
\begin{quote}
O primeiro ato ceça por uma oração de defesa de Freud {[}...{]} ele
...
\textbf{4) Por uma leitura reparadora do destino das mulheres criado
...
Simone de Beauvoir citando Poulain de la Barre
...
\textbf{Atas da Sociedade Psicanalítica de Viena: mulheres fazendo os
...
intenções. (...) Mulheres que tem muitos amantes são na verdade mulheres
...
\textbf{"Ainda essa discussão sobre patriarcado?": qual a regra do jogo
...
(...) As médicas, que não dispõem desta autoridade (paterna), são mais
...
\textbf{Mas "o inconsciente não tem sexo"... : aproximações do
...
\textbf{Mulheres questionando A Psicanálise }
...
de patriarcado. (Mitchell, 1974, p.xxvi)
\end{quote}
...
\textbf{Conclusão: manutenção da forma através da exploração do
conteúdo}
...
em\href{https://imaginenoborders.org/pdf/zines/UnderstandingPatriarchy.pdf}{\emph{https://imaginenoborders.org/pdf/zines/UnderstandingPatriarchy.pdf}}
...
5) \emph{Bêtes Noirs}: Uma releitura interseccional do texto freudiano
sobre homossexualidade feminina\footnote{Taduzido do inglês por Léa
  Silveira.}

\emph{Marita Vyrgioti}

\emph{Shall I never again, hand in hand with you.}

\emph{Walk over green and flowery meadows}

\emph{In the sunshine?}

\emph{Shall I never again, hand in hand with you, }

\emph{Endure life's burdens willingly}

\emph{Because we are together?}

\emph{One more time, hand in hand with you,}

\emph{On your shoulder let me lament to you}

\emph{How bitterly alone I am.}

Poema escrito por Melanie Klein em torno de 1920

\textbf{Fantasmas lésbicos: Homossexualidade na história da psicanálise}
...
\textbf{A homossexualidade em mulheres como tabu do psicanalista}
...
excelente influência sobre sua mente agitada {[}...{]}" (Grosskurth
1986, 84).
\end{quote}
...
\section{\texorpdfstring{\textbf{Homossexualidade feminina,
promiscuidade e
pele}}{Homossexualidade feminina, promiscuidade e pele}}\label{homossexualidade-feminina-promiscuidade-e-pele}
...
assumir a homossexualidade em um ambiente branco {[}...{]} foi
...
\textbf{Freud interseccional: Revisitando a psicogênese de um caso de
...
\section{\texorpdfstring{\textbf{Conclusão}}{Conclusão}}\label{conclusuxe3o}
...
\textbf{6)} \textbf{Fricção entre corpo e palavra: crítica ao
\emph{Moisés} de Freud e Lacan}

\emph{Alessandra Parente}

\emph{Em todo traje hei de sentir as penas,}

\emph{Da vida mísera o cortejo. }

\emph{Sou velho, pra brincar apenas,}

\emph{Jovem sou, pra ser sem desejo.}

\emph{Que pode, Fausto, o mundo dar-te?}

\emph{Deves privar-te, só privar-te!}

\emph{É o eterno canto, este, que assim}

\emph{A todo ouvido vibra e ecoa,}

\emph{Que a vida inteira, até o seu fim,}

\emph{Cada hora, rouca, nos entoa.}

\emph{Só com pavor desperto de manhã,}

\emph{Quase a gemer de amargo dó,}

\emph{Ao ver o dia, que, em fugida vã,}

\emph{Não me cumpre um desejo, nem um só;}

\emph{Que até o presságio de algum gozo}

\emph{Com fútil critiquice exclui,}

\emph{Que as criações de meu espírito audacioso}

\emph{Com farsas mil da vida obstrui. }
...
\textbf{Das tripas, coração}

\emph{A diferença sexual}

\emph{é uma heterodivisão }

\emph{do corpo na qual }

\emph{a simetria não é possível.}
...
imagem contra negatividade. ``Recusa {[}...{]} {[}ao{]} que dá valor ao
...
pelo termo \emph{falo}\footnote{A este respeito Cf. Silveira, L. (2017)
  \href{https://revistalacuna.com/tag/lea-silveira/}{\emph{https://revistalacuna.com/tag/lea-silveira/}}}?
...
apetitosa? Agora, não! Ai, que medo, sozinho é melhor...''. Diante dessa
...
ouvintes, principalmente de Freud: ``{[}...{]} tornar funcional o órgão
inferior {[}...{]} acontece por meio da compensação: a inferioridade do
...
mesmo objeto que ele buscará o gozo {[}...{]}. (Aulagnier, 1961-2/2003,
p. 287-8).
\end{quote}
...
muscular como ideal, acaba por reverter-se em... mais violência, só que
...
\textbf{YHWY e o Nome-do-Pai}

\emph{{[}...{]} nós {[}psicanalistas{]} sempre nos distinguimos }

\emph{por manipular os corpos através das palavras.}

\emph{No entanto, no limite, agora já não haveria}

\emph{mais nenhuma razão para acreditar }

\emph{que não devamos fazer o contrário: }

\emph{manipular as palavras em função }

\emph{dos corpos ou através da imagem.}
...
\emph{a contrassexualidade aponta para a substituição }

\emph{desse contrato social que denominamos }

\emph{Natureza por um contrato contrassexual.}

\emph{No âmbito do contrato contrassexual, }

\emph{os corpos se reconhecem }

\emph{a si mesmos não como homens ou mulheres, }

\emph{e sim como corpos falantes,}

\emph{e reconhecem os outros corpos como falantes}
...
voltas com o ``corpo falante''\footnote{Cf. Miller, J-A (2016)
  \href{https://www.wapol.org/pt/articulos/Template.asp?intTipoPagina=4\&intPublicacion=13\&intEdicion=9\&intIdiomaPublicacion=9\&intArticulo=2742\&intIdiomaArticulo=9}{\emph{https://www.wapol.org/pt/articulos/Template.asp?intTipoPagina=4\&intPublicacion=13\&intEdicion=9\&intIdiomaPublicacion=9\&intArticulo=2742\&intIdiomaArticulo=9}}}
...
\begin{quote}
{[}...{]} só sem imagens seria possível pensar o objeto plenamente. Uma
...
\textbf{Da faxina geral ao gozo possível}

{[}...{]} o que faltaria ao ensino de Lacan
...
efetivamente, esse passo fora da psicanálise.
...
{[}...{]} mas, ao contrário, o momento privilegiado em que, por um
...
YHWH, o Nome-do-pai, o falo, o gozo impossível são figuras de uma
...
\href{http://www4.pucsp.br/neils/downloads/v13_14_harvey.pdf}{\emph{http://www4.pucsp.br/neils/downloads/v13\_14\_harvey.pdf}},
acesso em 10/04/2019.

\_\_\_\_\_\_\_ ``O ``novo imperialismo'': acumulação por desapossamento
(Parte II)''. In:
\href{http://www4.pucsp.br/neils/downloads/v15_16_david_harvey.pdf}{\emph{http://www4.pucsp.br/neils/downloads/v15\_16\_david\_harvey.pdf}},
acesso em 10/04/2019.
...
Marx, K. (1897) \emph{O Capital}, v. I. In: Coleção \emph{Os
