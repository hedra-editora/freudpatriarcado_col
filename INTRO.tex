...
empregava a palavra ``genitor''. O termo não carregava referências à filiação biológica e reportava"-se ao homem que, ao exercer autoridade sobre uma família ou sobre um domínio, não dependia de nenhum outro homem. É no final do século \versal{XIX}, no contexto de teorias preocupadas em
...
partir dos quais Freud foi relido: \versal{I}. Revisitando os pilares de Freud;
\versal{II}. Interstícios do texto freudiano: acerto de contas; \versal{III}.
Extraterritorialidades: o olhar lançado de fora na análise de Freud; \versal{IV}.
Contra o mestre: Freud em atrito com as ideias de seus contemporâneos;
\versal{V}. De Freud aos debates atuais: psicanálise e feminismo.
...
Talvez num tom que Donna Haraway reconheceria como blasfemo, ``Fricção
...
que, segundo Alessandra Martins Parente, ainda se mantém presente em Lacan.
...
destacar elementos por ele abordados ainda no começo do século \versal{XX}. Tais
...
é, sem dúvida, a ``Introdução \versal{II} a \emph{Feminine sexuality}'', escrita em 1982
