...
\textbf{12) Introdução a \emph{Feminine sexuality}}\footnote{Traduzido
...
\begin{quote}
Freud adianta que só há libido masculina. O que quer dizer isso? --
...
mulher -- se é que esse ser assume o que quer que seja por sua conta
(Lacan, \emph{Encore}, SXX, 1972-3).
\end{quote}
...
satisfeito). Contra isso, ele citou a afirmação de Freud: ``(...)
...
`genital' para resolvê-la através da maturação da ternura {[}...{]},
...
biologismo residual ao qual ela é tão facilmente assimilada: ``(...) a
pulsão genital não existe, ela só pode se f... (...) no campo do Outro''
...
originalmente definido por Freud (``uma dimensão {[}...{]} cada vez mais
...
fundamental. (...) Isso é negligenciar o fato de que o exterior é dado
...
(``falocentrismo (...) estritamente impossível de deduzir de qualquer
...
\includegraphics[width=2.06597in,height=2.11319in]{media/image1.png}

(Lacan, 1956, p. 499, \emph{p. 151}, \emph{p. 502})

(o que, na verdade, está aberto à objeção de parecer reverberar uma
...
\includegraphics[width=1.72639in,height=1.40556in]{media/image2.png}
...
mulher ... é a representação da sexualidade que condiciona o modo como
...
morto... que se esconde atrás do véu para dali convocar sua adoração''?,
C, p. 95).
...
\item
  ...
  efeito do discurso, ... ao ser inscrito nele apenas como castração''
  (SXVIII, 12, p. 4);
\item
...
\emph{nós dois somos um só}. É daí que parte a ideia do amor {[}...{]} o
...
o próximo como a si mesmo {[}...{]} o mandamento estabelece a abolição
...
a mulher, lhe é diferenciada {[}...{]} chamada mulher e difamada'',
...
Para Lacan, homens e mulheres estão, sempre, na linguagem (``(...) o que
...
(``quanto mais o homem confundir a mulher com Deus... menos ele é'',
...
{[}da mulher{]} barrado ... relaciona-se com o significante O quando ele
...
de Lacan (``a sexualidade feminina ... como o esforço de um gozo envolto
...
COWIE, E. "Woman as sign", \emph{m/f}, I, 1978, pp. 49-63.
...
MacCABE, C. (ed.) \emph{The talking cure -- Essays in psychoanalysis and
...
\textbf{13) Imposições sexuais e diferenças entre os sexos -- Bruxas,
\emph{femmes seules,} solteironas e Sigmund Freud}

\textbf{Beatriz Santos}

Psicanalista,

Professora do Departamento de Estudos Psicanalíticos da Université Paris
Diderot
...
\textbf{A heterossexualidade como instituição}
...
\textbf{Diferenças anatômicas, consequências psíquicas}
...
\textbf{14) Simbolicismo e circularidade fálica: em torno da crítica de
...
\emph{(...) notre manque d'imagination dépeuple toujours l'avenir (...)
}
...
político\footnote{Não é menos surpreendente a conclusão que Kristeva
  ...
  \emph{"(...) na rejeição da função paterna por lésbicas e mães
  solteiras pode ser vista uma das formas mais violentas que assume a
  rejeição do simbólico (...), assim como uma das mais fervorosas
...
1. Como as identidades sociais das pessoas podem ser fabricadas e
...
2. Como grupos sociais são formados e dissolvidos. Como podem ser
formadas identidades coletivas, capazes de se colocar como agentes
sociais coletivos.

3. Como a hegemonia cultural de grupos dominantes numa dada sociedade é
...
4. Como vislumbrar perspectivas de mudança social emancipatória e
...
simbólica' monolítica e onipresente; e (...) o fato de a esse sistema
...
discursivas. Contudo (...) tais promessas permanecem não cumpridas. O
...
são os \emph{Três ensaios...} (Freud, 1905/2016) senão a defesa de que
...
FREUD, Sigmund. (1912-1913) ``Totem e tabu: Algumas concordâncias entre
...
PAGLIA Camille. (2008) ``Feminism past and present~: Ideology, action,
...
\textbf{15) Sobre o declínio da autoridade paterna: uma discussão entre
Teoria Crítica e psicanalistas feministas}

\textbf{Virginia Helena Ferreira da Costa}
...
\textbf{Contexto de discussão: o declínio da autoridade paterna }
...
externa.\footnote{\protect\hypertarget{_Hlk2193392}{}{}Chodorow, Nancy.
...
comenta: \protect\hypertarget{_Hlk531969194}{}{}``a dominação
...
\textbf{Lasch \emph{versus} teóricas feministas: uma crítica ao apego ao
patriarcado}
...
caminho para a ruína moral das crianças sob a influência de mãe. (...)
...
para transmitir aprovação, ao invés de críticas.''\footnote{Barrett,
  ...
  sociedade masculina. (...) O caráter feminino é uma cópia do positivo
...
nostálgica da autoridade paterna na era da razão.''\footnote{\protect\hypertarget{_Hlk2193646}{}{}Benjamin,
...
autoridade paterna tenha falido ou até mesmo sumido\footnote{Segundo as
  ...
  ~\href{https://biblioteca.ibge.gov.br/index.php/biblioteca-catalogo?view=detalhes\&id=288941}{\emph{https://biblioteca.ibge.gov.br/index.php/biblioteca-catalogo?view=detalhes\&id=288941}}
  ...
  de 20\% em 15 anos.''
  (\href{https://projetocolabora.com.br/genero/familias-chefiadas-por-mulheres/}{\emph{https://projetocolabora.com.br/genero/familias-chefiadas-por-mulheres/}})
...
\textbf{A objetificação da mulher em Freud e uma saída feminista}
...
crítico de questões feministas\footnote{Concebemos que, ao relacionar à
  ...
  automática (...). No creo que la oposición biológica entre trabajo
  intelectual y actividad genésica explique la `imbecilidad fisiológica'
  de la mujer (...). Opino, en cambio, que el hecho indudable de la
...
psicológica se produz. (...) Ao tentar entender a psicologia das
...
instinto {[}\emph{Trieb}{]} pode alcançar a sua meta''\footnote{Freud,
  S. \textsuperscript{``Os instintos e seus destinos'', p.} 58.} de
...
seja, ``Freud acaba por passar da análise das relações objetais (...)
aos elementos de análise das características do conhecimento
objetivo.''\footnote{David-Ménard, Monique. \textsuperscript{\emph{La
...
\protect\hypertarget{_Hlk2193209}{}{}. Adorno, Theodor W. \emph{Minima
...
. David-Ménard, Monique. \textsuperscript{\emph{La folie dans la raison
...
. Freud, S. \textsuperscript{``Os instintos e seus destinos'' In
...
\textbf{16) Sequelas patriarcalistas em Freud segundo Luce Irigaray:
...
repartições, classes, e retóricas, regulações, códigos {[}...{]}, a
...
\textbf{Em combate ao \emph{um} sexo}
...
lábios da boca-lábios vaginais = mulher X falo-pênis = homem). Além do
...
da alteridade do Mesmo nos moldes do eu, ``ao que ela responde: não...
...
significados seriam conferidos às mulheres. ``{[}...{]} o feminino é
...
de 2014 de:
\textless{}\url{https://www.academia.edu/403078/Luce_Irigaray_the_un_dutiful_daughter_of_psychoanalysis._A_feminist_moving_through_and_beyond_the_phallogocentric_discourse_of_psychoanalysis}\textgreater{}.
...
\href{https://repositorio.ufsc.br/bitstream/handle/123456789/1350/a_psicanalise_nas_ondas.pdf?sequence=1}{\emph{https://repositorio.ufsc.br/bitstream/handle/123456789/1350/a\_psicanalise\_nas\_ondas.pdf?sequence=1}}
