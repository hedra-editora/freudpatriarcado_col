...
satisfação'' ``(a noção de frustração (que nunca foi empregada por %%%% CONFUSO DEMAIS 
...
privilegiado das proibições'' (\versal{SXVIII}, 6, p.~10).\footnote{As referências
  dos Seminários \versal{XVIII} (``\emph{L´envers de la psychanalyse}'', \textsc{lacan},
  1969-70) e \versal{XXI} (``\emph{Les non"-dupes errent}'', \textsc{lacan}, 1973-4)
...
para ambos os sexos (\textsc{jones}). %%ano?

É essa mesma continuidade que é posta em xeque na concepção aqui
apresentada. O conceito de falto e o complexo de castração testemunham, %falto mesmo?
...
\item
  ...
  (\versal{SXVIII}, 12, p. 4); %O que é esse 12?
\item
...
da diferença sexual'' (\versal{SXXI}, 4, p. 3), e à própria ideologia da unidade %4??
...
\emph{lalangue}.\footnote{O termo de Lacan para ``\emph{langue}''
  ...
  apreensão do sujeito (ver \versal{SXX}, p. 126-7, p. 148-9).} Esse ``fazer
...
reflete o sexual, mas que o suplementa'' (\versal{SXXI}, 15, p. 9). A sexualidade %15?
...
6, p. 9-10).\footnote{Ver Otto Fenichel, num artigo ao qual Lacan, %6??
...
homem não é a mulher'' (\versal{SXXI}, 6, p. 9). %6??
...
irremediavelmente uma errância'', \versal{SXXI}, 6, p. 11). %6??
...
(\emph{Ornicar?}, 20-1, p. 12) (referência às mulheres analistas nas %20-1??
...
ele não entende nada'' (\versal{SXXI}, 7, p. 16). Aqui há um risco de devolver à %7?
...
colocam em risco seu acesso a qualquer objeto (Montrelay),\footnote{Montrelay %Informar ano para seguir padrão
...
mulher para si mesma e, através disso, para outras mulheres (Irigaray). %Idem da nota acima
...
sexual'', \versal{SXXI}, 4, p. 18), mas, para ele, o que deve ser questionado é a %4??
...
\emph{femmes seules}, solteironas e Freud, \footnotesize\emph{por Beatriz Santos}}
...
requisitos --- mas na verdade sem outra consistência que essa. %%FALTA REFERENCIA
\end{quote}
...
para transmitir aprovação, ao invés de críticas'' (\textsc{barrett},
  ...
  (\textsc{horkheimer}, 1973, p.~137). Já Adorno, em \emph{Minima
