...
no coração de \emph{Totem e tabu} (Freud, 2012) --- deu ensejo
...
palavras''} (Lacan, 2008, p. 79) O que, para mim,
...
repúdio do feminino é fundante da cultura (Freud, 2010).
...
preocupar com a enunciação.\footnote{Basta, nesse sentido, lembrarmos,
  por exemplo, a amplitude dos trabalhos de É. Benveniste (2006).}
...
são os \emph{Três ensaios\ldots{}} (Freud, 2016) senão a defesa de que
...
sentido é sexual (Lacan, 2003), que ele implica o corpo como lugar
...
de não se possuir um pênis.\footnote{Desenvolvi essa argumentação em
  outro lugar (Silveira, 2017). Ver também Gallop, 2001.}
...
se expressar com o conteúdo tradicional do complexo de Édipo\footnote{Para
  ...
  final de sua obra, ver Van Haute \& Geyskens, 2016.} (ao menos
...
Fraser, 1987, p 38). O que Fraser enxerga aí é que o pequeno trecho
...
Em: \textbf{Obras completas. Volume 6}. Trad. P. C. de Souza. São Paulo: Companhia das Letras, 2016.
...
\_\_\_\_\_\_. (1979) ``Women's time''. (Trad. A. Jardine, H. Blake)
