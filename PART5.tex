...
\hedramarkboth{Introdução \versal{II} a \emph{Feminine sexuality}}{}

\begin{flushright}
\emph{Jacqueline Rose}\footnote{Autora de vários livros sobre psicanálise, literatura e cultura,
...
Como Juliet Michell descreve acima,\footnote{Cf. nota 4, acima. {[}\versal{N.~T.}{]}} há uma tendência, quando se
...
Juliet Michtell descreveu acima.\footnote{Cf. nota 4, acima. {[}\versal{N.~T.}{]}} Mas, para Lacan, este não é um momento
...
Os dois últimos textos traduzidos aqui (\versal{\emph{E}} e \versal{O})\footnote{Cf. nota 1, acima. {[}\versal{N.~T}{]}} pertencem a esse
...
\begin{Parskip}
\versal{BENVENISTE}, Émile. ``La nature des pronoms''. Em: \emph{Problèmes de
...
\versal{CHODOROW}, Nancy. \emph{The reproduction of mothering -- Psychoanalysis and
the sociology of gender}. Londres: University of California Press, 1979.

\versal{COWIE}, Elizabeth. ``Woman as sign''. Em: \emph{m/f}, \versal{I}, 1978, p. 49-63.

\versal{DEUTSCH}, Helene. ``The significance of masochism in the mental life of women''. Em:
\emph{\versal{IJPA}}, \versal{XI}, 1930, p. 48-60.

\versal{FENICHEL}, Otto. ``The symbolic equation girl = phallus''. Em: \emph{\versal{PQ}}, \versal{XVIII} (3), 1949, p. 303-21.

\versal{FREUD}, Sigmund. \& \versal{BREUER}, Josef. \emph{Studies on hysteria}. (\versal{SE}, \versal{II}, 1893-5).

\_\_\_\_\_\_. \emph{Project for a scientific psychology}. (\versal{SE, I}, 1895).

\_\_\_\_\_\_. \emph{Three essays on the theory of sexuality}. (\versal{SE, VII}, 1905, p. 123-245).

\_\_\_\_\_\_. ``On the universal tendency to debasement in the sphere of love'' (Contributions to the psychology of love, \versal{II}) (\versal{SE}, \versal{XI}, 1912, p. 177-90). 
...
\_\_\_\_\_\_. \emph{Beyond the pleasure principle}. (\versal{SE}, \versal{XVIII}, 1920, p. 3-64).

\_\_\_\_\_\_. (1938) ``Splitting of the Ego in the process of
defence'' (\versal{SE}, \versal{XXIII}, 1940, p. 273-8).

\versal{IRIGARAY}, Luce. \emph{Speculum de l'autre femme}. Paris: Minuit, 1974.

\_\_\_\_\_\_. \emph{Ce sex qui n'en est pas un}. Paris: Minuit, 1977.

\versal{JONES}, Ernest. ``The early development of female sexuality''. Em:
...
\versal{KLEIN}, Melanie. ``The importance of symbol formation in the development of the
ego''. Em: \emph{\versal{IJPA}}, \versal{IX}, 1930, p. 23-39.

\versal{LACAN}, Jacques. (1936) ``Le stade du mirroir comme formateur de la fonction du
...
\_\_\_\_\_\_. (1972-3) \emph{Encore}. Le séminaire \versal{XX}. Paris: Seuil, 1975.
\emph{Mais, ainda}. Trad. M. D. Magno. Rio de Janeiro: Zahar, 2008.

\_\_\_\_\_\_. ``Les non"-dupes errent''. Le séminaire \versal{XXI}, 1973-4 (manuscrito
inédito).

\_\_\_\_\_\_. \emph{Scilicet}, review of \emph{le champ freudien}, \versal{I"-VII}.
Paris: Seuil, 1968-76.
...
\versal{LEMOINE"-LUCCIONI}, Eugénie. \emph{Partage des femmes}, (\emph{le champ freudien}).
Paris: Seuil, 1976.

\versal{MACCABE}, Colin. \emph{The talking cure -- Essays in psychoanalysis and
language}. Londres: Macmillan, 1981.

\versal{MANNONI}, Maud. \emph{L'enfant, sa ``maladie'' et les autres}, (\emph{le champ
freudien}). Paris: Seuil, 1967. \emph{The child, his illness and the
others}. Londres: Tavistock, 1970.

\versal{MONTRELAY}, Michele. ``Recherches sur la femininité''. Em: \emph{Critique}, \versal{XXVI},
Paris, 1970, p. 654-74. Edição revista: ``Inquiry into femininity''.
Trad. e Intro. Parveen Adams. Em: \emph{m/f}, \versal{I}, 1978, p. 65-101.

\versal{RIVIÈRE}, Joan. ``Womanliness as masquerade''. Em: \emph{\versal{IJPA}}, \versal{X}, 1929, p. 303-13.

\versal{RUBIN}, Gayle. ``The Traffic in Women: Notes on the 'Political Economy' of
Sex''. Em: \textsc{reiter}, Rayna R. (ed.). \emph{Toward an Anthropology of
Women}. Monthly Review Press, 1975, p. 157-210.

\versal{SAFOUAN}, Moustapha. \emph{Etudes sur l'\OE dipe}, (\emph{le champ freudien}).
Paris: Seuil, 1974. ``Is the Oedipus complex universal?''. Trad. B. Brewster. Em: \emph{m/f}, 5-6, 1981, p. 83-90.

\versal{SAUSSURE}, Ferdinand de. (1915) \emph{Cours de linguistique générale}. Ed.
Tullio de Mauro. Paris: Payot, 1972. \emph{Course in general
linguistics} (revised ed.). Londres; Fontana, 1974.

\versal{SEGALL}, Hanna. ``Notes os symbol formation''. Em: \emph{\versal{IJPA}}, \versal{XXXVIII}, 1957, p. 391-7.

\versal{STOLLER}, Robert. ``A contribution to the study of gender identity''. Em:
\emph{\versal{IJPA}}, \versal{XLV}, 1965, p. 220-6.

\versal{WINNICOTT}, Donald. (1967) ``Mirror"-role of the mother and family in child
...
\begin{flushright}
\emph{Beatriz Santos}\footnote{Psicóloga clínica e psicanalista. Desde 2016 ensina no
...
\emph{\versal{MLF}. Psychanalyse et politique 1968-2018: 50 ans de libération des femmes. Volume \versal{I}. Les premières années}. Coletivo, Paris: Editions Des femmes"-Antoinette Fouque, 2018.

\textsc{prokhoris}, Sabine. \emph{Le sexe prescrit. La différence sexuelle en
question}. Paris: Flammarion, 2000.

\versal{RICH}, Adrienne. (1980) ``Compulsory Heterosexuality and Lesbian Existence''. Em: \emph{Journal of Women's History}, v.~15, n.~3, p.~11-48, autumn 2003. Traduzido em português como ``Heterossexualidade compulsória e existência lésbica''. Em \emph{Bagoas -- Estudos gays: gêneros e sexualidades}, v.~4, n.~05, 27/11/2012.
...
Nancy Fraser ao ``lacanismo''\footnote{Partes desse trabalho foram
  ...
  devido à generosa leitura e aos ricos comentários de Alessandra Martins
...
\_\_\_\_\_\_. (2013) ``Contra o `simbolicismo': Usos e abusos do
...
\versal{GALLOP}, Jane. (1988) ``Além do falo''. Em: \emph{Cadernos Pagu}, n.~16, p.
267-287, 2001.
...
\versal{LACAN}, Jacques. (1973) ``O aturdito''. Em: \emph{Outros escritos}. Rio de
Janeiro: Zahar, 2003.

\_\_\_\_\_\_. (1975) \emph{O seminário, livro 20: Mais, ainda}.
{[}1972-1973{]}. Trad. M. D. Magno. Rio de Janeiro: Zahar, 2008.

\_\_\_\_\_\_. (1991) \emph{O seminário, livro 17: O avesso da
psicanálise}. {[}1969-1970{]}. Trad. M. D. Magno. Rio de Janeiro: Zahar, 1992.

\versal{MARIN}, Inara. ``Déficit psicanalítico na teoria crítica feminista''. Em:
...
\begin{flushright}
\emph{Virginia Helena Ferreira da Costa}\footnote{Pesquisadora de Pós"-doutorado (\versal{PNPD-CAPES}) em Filosofia pela Universidade Federal do Espírito Santo (\versal{UFES})
...
\section{Lasch \emph{versus} teóricas feministas: uma~crítica~ao~apego~ao~patriarcado}
...
\begin{Parskip}
\textsc{adorno}, Theodor W. \emph{Minima
moralia: reflexões a partir da vida danificada}. Lisboa: Edições 70, 1992.

\_\_\_\_\_\_\_\_. ``The problem of a new type of human being'' Em:
\emph{Current of Music: Elements of a radio theory}. Cambrigde: Polity Press, 2009.

\textsc{adorno}, Theodor W.; \textsc{levinson}, Daniel J. \& \textsc{sanford}, Nevitt. \emph{The Authoritarian Personality}. \versal{USA}: Harper \& Brothers, Copyright American Jewish Committee,
1950.

\textsc{barrett}, Michèle; \textsc{mcintosh}, Mary. \emph{The anti"-social family}.
London/New York: Verso, 1991.

\textsc{benjamin}, Jessica. ``Authority and family revisited: or a world
without fathers''. Em: \emph{New German Critique}, no.~13, Special Feminist
Issue, p.~35-57, Winter, 1978.

\_\_\_\_\_\_\_\_. ``The end of internalization: Adorno's social
psychology''. Em: \emph{Telos}, no.~32, p.~42-64, 1977.

\textsc{braidotti}, Rosi. ``A política da diferença ontológica''. Em: \textsc{brennan},
Teresa. \emph{Para além do falo}. Rio de Janeiro: Ed. Rosa dos Tempos, 1989.

\textsc{buhle}, Mari Jo. \emph{Feminism and its discontents -- a century of
struggle with psychoanalysis}. Cambridge/London: Harvard University Press, 1998.

\textsc{chodorow}, Nancy. \emph{Feminism and Psychoanalytic Theory}. New
Haven/London: Yale University Press, 1989.

\_\_\_\_\_\_\_\_. \emph{Feminities, masculinities, sexualities -- Freud
and beyond}. Kentucky: The University Press of Kentucky, 1994.

\_\_\_\_\_\_\_\_. \emph{The reproduction of mothering -- psychoanalysis
and the sociology of gender}. Berkeley/Los Angeles/London: University of
California Press, 1978.

\textsc{costa}, Virginia Helena Ferreira da. ``A `sociologização' da
...
\textsc{david"-Ménard}, Monique. \emph{La folie dans la raison
pure -- Kant lecteur de Swedenborg}. Paris: Librairie J. Vrin, 1990.

\textsc{freud}. Sigmund. ``Algunas consecuencias psíquicas de la diferencia
anatómica entre los sexos''. Em: \emph{Obras completas Volumen 19}.
Argentina: Amorrortu editores, 2001.

\_\_\_\_\_\_\_\_. ``El sepultamiento del complejo de Edipo''. Em:
\emph{Obras completas Volumen 19}. Argentina: Amorrortu editores, 2001.

\_\_\_\_\_\_\_\_. \emph{Esquisse d'une psychologie scientifique}.
Toulouse: Éditions Érès, 2011.

\_\_\_\_\_\_\_\_. ``La moral sexual `cultural' y la nerviosidad
Moderna''. Em: \emph{Obras completas Volumen 9}. Argentina: Amorrortu
editores, 1992.

\_\_\_\_\_\_\_\_. ``Nuevas conferencias de Introducción al
psicoanálisis: 33ª. Conferencia: la feminidad''. Em: \emph{Obras
completas Volumen 22}. Argentina: Amorrortu editores, 1992.

\_\_\_\_\_\_\_\_. ``Os instintos e seus destinos''. Em:
\emph{Introdução ao narcisismo, Ensaios de metapsicologia e outros
textos (1914-1916)}. São Paulo: Companhia das Letras, 2010.

\_\_\_\_\_\_\_\_. ``Psicologia das massas e análise do Eu''. Em:
\emph{Psicologia das massas e análise do Eu e outros textos (1920-1923)}.
São Paulo: Companhia das Letras, 2011.

\_\_\_\_\_\_\_\_. ``Sobre la sexualidad femenina''. Em: \emph{Obras
completas Volumen 21}. Argentina: Amorrortu editores, 1992.

\textsc{horkheimer}, Max. ``The Family''. Em: \emph{Aspects of Sociology}. London:
Heinemann, 1973.

\_\_\_\_\_\_\_\_. ``Authority and the Family''. Em: \emph{Critical Theory
-- Selected Essays}. New York: Continuum, 1982.

\textsc{institut für sozialforschung}. Ed. \emph{Studien über Autorität und
Familie -- Forschungsberichte aus dem Institut für Sozialforschung}.
Lüneburg: zu Klampen Verlag, 1987.

\textsc{lasch}, Christopher. \emph{A cultura do narcisismo}. Rio de Janeiro:
Imago, 1983.

\_\_\_\_\_\_\_\_. \emph{Haven in a Heartless World}. New York: W. W.
Norton \& Company, 1995.

\textsc{matos}, Olgária. \emph{Os arcanos do inteiramente outro: a Escola de
Frankfurt, a melancolia e a revolução}. São Paulo: Ed. Brasiliense, 1995.

\textsc{mitchell}, Juliet. \emph{Psychoanalysis and Feminism -- a radical
reassessment of Freudian psychoanalysis}. New York: Basic Books, 1974.

\textsc{mitscherlich}, Alexander. \emph{Society with the Father: A Contribution
to Social Psychology}. Trans. Eric Mosbacher. New York: Harcourt, Brace and World Inc., 1963.

\textsc{moraes}, Maria Lygia Quartim de. \emph{Marxismo, psicanálise e
feminismo brasileiro}. Campinas: Unicamp/\versal{IFCH}, 2017.

\textsc{rose}, Jacqueline. \emph{Sexuality in the field of vision}. London/New
York: Verso, 1986.

\textsc{tort}, Michel. \emph{Fin du dogme paternal}. Malesherbes: Flammarion/Aubier, 2005.

\textsc{whitebook}, Joel. \emph{Perversion and utopia -- a study in
...
\begin{flushright}
\emph{Rafael Kalaf Cossi}\footnote{Psicanalista; psicólogo, mestre e doutor pela Universidade
...
\begin{Parskip}
\textsc{brennan}, Teresa (Org.). \emph{Para além do falo: uma crítica a Lacan do
ponto de vista da mulher}. Rio de Janeiro: Record/Rosa dos tempos, 1997.

\textsc{cixous}, Helene. (1975) ``The laught of the Medusa''. Em: \versal{MARKS}, E.; \versal{DE
COURTIVRON}, I. \emph{New french feminism}. \versal{USA}: Schocken Books, 1981.

\textsc{fink}, Bruce. \emph{O sujeito lacaniano: entre a linguagem e o gozo}.
Rio de Janeiro: Jorge Zahar, 1998.

\textsc{freud}, Sigmund. (1931). \emph{Sexualidade feminina}. Trad. Paulo César de Souza.
São Paulo: Companhia das letras, volume \versal{XVIII}, 2010.

\textsc{gallop}, Jane. \emph{The daughter's seduction -- feminism and
psychoanalysis}. Ithaca: Cornell University Press, 1982.

\textsc{geerts}, Evelin. (2010/11) ``Luce Irigaray: the (un)dutiful daughter of
...
\textsc{grosz}, Elizabeth. \emph{Sexual subversions: three french feminists}.
Austrália: Allen \& Unwin, 1989.

\textsc{horney}, Karen. (1967). \emph{Feminine Psychology}. Norton: \versal{NY} \& London, 1993.

\textsc{irigaray}, Luce. (1974) \emph{Speculum of the other woman}. Trad. Gillian C.
Gill. Ithaca: Cornell University Press, 1985.

\_\_\_\_\_\_\_\_. (1977) \emph{The sex which is not one}. Trad. Catherine Porter;
Carolyn Burke. Ithaca: Cornell University Press, 1985.

\_\_\_\_\_\_\_\_. (1984) \emph{An ethics of sexual difference}. Trad. Carolyn
Burke \& Gillian C. Gill. Ithaca: Cornell University Press, 1993.

\textsc{lago}, Mara Coelho de Souza. (2012) ``A psicanálise nas ondas dos feminismos''.
Disponível em: \textless{}\emph{https://bit.ly/2O42VJ3}\textgreater{}. Acesso em: Recuperado em 27/03/2014.

\textsc{preciado}, Beatriz. \emph{Manifiesto contra"-sexual -- prácticas
subversivas de identidad sexual}. Madrid: Editorial Opera Prima, 2002.

\textsc{roth}, Michael. \emph{Freud: conflito e cultura: ensaios sobre sua vida,
obra e legado}. Rio de Janeiro: Jorge Zahar, 2000.

\textsc{whitford}, Margaret. \emph{The Irigaray reader}. Malden/Oxford: Blackwell
