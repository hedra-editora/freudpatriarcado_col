...
\chapter*{Introdução \versal{II} a \emph{Feminine sexuality}\footnote[*]{Traduzido
  ...
  {[}\versal{N.~T.}{]}}}
\addcontentsline{toc}{chapter}{Introdução \versal{II} a \emph{Feminine sexuality}, \footnotesize\emph{por Jacqueline Rose}}
\hedramarkboth{Introdução II a «Feminine sexuality»}{}

\begin{flushright}
\textsc{jacqueline rose}\footnote[\dag]{Autora de vários livros sobre psicanálise, literatura e cultura,
feminismo e Oriente Médio. É co"-fundadora do \emph{Independent Jewish Voices},
lançado no Reino Unido em 2007, e membro da \emph{British Academy}. Rose é
colaboradora frequente da \emph{London Review of Books} e do \emph{The Guardian}, entre
...
mulher --- se é que esse ser assume o que quer que seja por sua conta.}{\textsc{lacan}, \emph{Encore}, \versal{SXX}, 1972--3}
%\end{quote}

\noindent{}Os textos que publicamos aqui\footnote{Ver nota *. {[}\versal{N.~T.}{]}} retornam
...
começou com a análise da histeria (\textsc{freud} \& \textsc{breuer}, \versal{II}, 1893--5) --- e
insistiu, cabe destacar, no fato de que o paciente histérico poderia
também ser um homem (\textsc{freud}, \versal{I}, 1886). Foi seu fracasso em analisar uma
paciente histérica --- ``Dora'' (\textsc{freud}, \versal{VII}, 1905) ---, em termos de um
...
Além disso, Freud resgatou essa questão no momento em que estava
...
anos 1920 e 1930, e a de Nancy Chodorow (1979),\footnote{Ver nota 11,
  abaixo.} quando se fala a partir da psicanálise para o feminismo hoje.
...
portanto, partes de um mesmo projeto.
...
catexia alucinatória da criança no objeto pelo qual ela chora (\textsc{freud}, \versal{I},
...
constantemente esse momento irredutível de divisão fundamental. O
...
p. 80) e, então, cada vez que a demanda da criança é respondida com a satisfação de suas necessidades, essa ``outra coisa'' é relegada ao lugar de sua impossibilidade original. Lacan designa isso ``desejo''. O que pode
...
satisfação'' (\textsc{freud}, \versal{XI}, 1912, p. 188--9, 149; cit. \versal{PP}\footnote{O texto
...
Como Juliet Michell descreve acima,\footnote{Cf. nota 2, acima. {[}\versal{N.~T.}{]}} há uma tendência, quando se
...
heterossexual seja explicada e não assumida (\textsc{freud}, \versal{VII}, 1905, p.
...
(\emph{Ornicar?}, 20--21, 1980, p.~16).\footnote{\emph{Ornicar?},
  ...
  1981, na Universidade de Paris \versal{VIII} (Sorbonne) (\textsc{lacan}, 1975-).} 
...
Juliet Michtell descreveu acima.\footnote{Cf. nota 2, acima. {[}\versal{N.~T.}{]}} Mas, para Lacan, este não é um momento
...
virtude de distorcer suas formas (\versal{C}, p.~87).
\end{quote}
...
privilegiado das proibições'' (\versal{SXVIII}, 6, p.~10).\footnote{As referências
  dos \emph{Seminários \versal{XVIII}} (``\emph{L´envers de la psychanalyse}'', \textsc{lacan},
  1969--70) e \emph{\versal{XXI}} (``\emph{Les non"-dupes errent}'', \textsc{lacan}, 1973--4)
  (manuscritos não publicados) são dadas pela semana e pela página do
  manuscrito. {[}\emph{O seminário \versal{XVIII}} já possui versão pulicada em
...
apresentada. O conceito de falo e o complexo de castração testemunham,
...
``Qualquer ser falante'' (\versal{E}, p. 150) deve estar alinhado em um ou outro
...
deriva de sua visibilidade (algo que foi alvo de crítica frequente), é apenas na medida em que a ordem do visível, a aparência, o
...
por outro lado, inteiramente submetida, assim como o homem (\versal{SII}, p.
304--5, \emph{p. 329}).
\end{quote}
...
\emph{nós dois somos um só}. É daí que parte a ideia do amor {[}\ldots{}{]} o problema é o de como pode haver um amor por um outro'' (\versal{SXX}, p. 46,
...
\emph{lalangue}.\footnote{O termo de Lacan para ``\emph{langue}''
  ...
  inconscientes, mas cujos efeitos vão além dessa reflexão, escapando à
  apreensão pelo sujeito (ver \versal{SXX}, p. 126--7, p. 148--9).} Esse ``fazer
...
Os dois últimos textos traduzidos aqui (\versal{\emph{E}} e \versal{O})\footnote{Cf. nota *, acima. {[}\versal{N.~T}{]}} pertencem a esse
...
6, p. 9--10).\footnote{Ver Otto Fenichel, num artigo ao qual Lacan 
  ...
  equação menina = falo, muitas vezes localizada como uma fantasia
...
[\versal{\emph{O}}]). Se a mulher é ``não toda'', escreve Lacan, então ``ela''
...
que podem ser organizadas em torno dessa posição.\footnote{Grande parte
  ...
  mentindo'' (cf. nota 22, acima); pois, se eu não sei, então como sei o
...
está constantemente submetida. O problema é que, uma vez que a noção de
...
tensão que percorre os capítulos, aqui traduzidos, do \emph{Seminário \versal{XX}} de
...
psíquica).\footnote{No momento em que escrevia isso, Lacan tinha acabado
  de dissolver sua escola em Paris, fazendo convergir para a declaração com a
  ...
  32, abaixo) descobriu que sua posição, em relação a isso, seria
...
mulher um estatuto de verdade (a mitologia tão denunciada). Mas, para Lacan, essa ``verdade'' do inconsciente é apenas aquele momento da divisão fundamental, pela qual o sujeito entrou na linguagem e na sexualidade, e o  constante fracasso de sua localização em ambas.
...
colocam em risco seu acesso a qualquer objeto (\textsc{montrelay}),\footnote{Montrelay 
...
mulher para si mesma e, através disso, para outras mulheres (\textsc{irigaray}).
...
em sua própria contiguidade'', \versal{C}, p. 97). Mas Lacan voltou a essa
...
aqui traduzidos\footnote{Referência ao volume \emph{Feminine sexuality}. {[}\versal{N.~T.}{]}}
...
\begin{bibliohedra}
\tit{BENVENISTE}, Émile. ``La nature des pronoms''. Em: \emph{Problèmes de
linguistique générale}. Paris: Gallimard, 1966, p. 251--7.
\emph{Problems in general linguistics}. Florida: University of Miami
Press, 1971, p. 217--22.

\titidem. ``De la subjectivité dans le langage''. Em: \emph{Problèmes}, 1958, p. 258--66.
(\emph{Problems}, p. 223--30).

\tit{CHODOROW}, Nancy. \emph{The reproduction of mothering -- Psychoanalysis and
the sociology of gender}. Londres: University of California Press, 1979.

\tit{COWIE}, Elizabeth. ``Woman as sign''. Em: \emph{m/f}, \versal{I}, 1978, p. 49--63.

\tit{DEUTSCH}, Helene. ``The significance of masochism in the mental life of women''. Em:
\emph{\versal{IJPA}}, \versal{XI}, 1930, p. 48--60.

\tit{FENICHEL}, Otto. ``The symbolic equation girl = phallus''. Em: \emph{\versal{PQ}}, \versal{XVIII} (3), 1949, p. 303--21.

\tit{FREUD}, Sigmund. \& \versal{BREUER}, Josef. \emph{Studies on hysteria}. (\versal{SE}, \versal{II}, 1893--5).

\titidem. \emph{Project for a scientific psychology}. (\versal{SE, I}, 1895).

\titidem. \emph{Three essays on the theory of sexuality}. (\versal{SE, VII}, 1905, p. 123--245).

\titidem. ``On the universal tendency to debasement in the sphere of love'' (Contributions to the psychology of love, \versal{II}) (\versal{SE}, \versal{XI}, 1912, p. 177--90). 
...
\titidem. \emph{Beyond the pleasure principle}. (\versal{SE}, \versal{XVIII}, 1920, p. 3--64).

\titidem. (1938) ``Splitting of the Ego in the process of
defence'' (\versal{SE}, \versal{XXIII}, 1940, p. 273--8).

\tit{IRIGARAY}, Luce. \emph{Speculum de l'autre femme}. Paris: Minuit, 1974.

\titidem. \emph{Ce sex qui n'en est pas un}. Paris: Minuit, 1977.

\tit{JONES}, Ernest. ``The early development of female sexuality''. Em:
\emph{\versal{IJPA}}, \versal{VIII}, 1927, p. 459--72.

\titidem. ``The theory of symbolism''. Em: \emph{British journal of
psychoanalysis}, \versal{IX} (2), 1916, p. 181--229.

\tit{KLEIN}, Melanie. ``The importance of symbol formation in the development of the
ego''. Em: \emph{\versal{IJPA}}, \versal{IX}, 1930, p. 23--39.

\tit{LACAN}, Jacques. (1936) ``Le stade du mirroir comme formateur de la fonction du
...
\titidem. ``Cure psychanalytique à l'aide de la poupée fleur''. Em:
\emph{Comptes rendus, réunion 18 October, Revue française de la
psychanalyse}, 4, Out"-Dez, 1949, p. 567.

\titidem. (1953) ``Fonction et champ de la parole et du langage en
psychanalyse''. Em: \emph{Écrits}, p. 237--322. \emph{Écrits: A
selection}, p. 30--113.

\titidem. (1954--55) \emph{Le moi dans la théorie de Freud et dans la technique de
la psychanalyse}. Le séminaire \versal{II}. Paris: Seuil, 1978. \emph{O
eu na teoria de Freud e na técnica da psicanálise}. Trad. M. C. L.
Penot e A. L. Q. de Andrade. Rio de Janeiro: Zahar, 1985.

\titidem. (1955--6) ``D'une question préliminaire à tout traitement possible de la
psychose''. Em: \emph{Écrits}, p. 531--83. \emph{Écrits: A
selection}, p. 179--225. \emph{Escritos}, p. 537--90.

\titidem. ``Les formations de l'inconscient''. \emph{Bulletin de
psychologie}, \versal{II}, 1957--8, p. 1--15.

\titidem. (1959) ``À la mémoire d'Ernest Jones: Sur sa théorie de
symbolisme''. Em: \emph{Écrits}, p. 697--717. ``À memória de Ernest Jones: Sobre
sua teoria do simbolismo''. \emph{Escritos}, p. 704--25.

\titidem. (1960) ``Guiding remarks for a congress on feminine sexuality''.
...
\titidem. (1964a) \emph{Les quatres concepts fondamentaux de la psychanalyse}.
Le séminaire \versal{XI}. Paris: Seuil, 1973. \emph{The four
...
\titidem. (1972--3) \emph{Encore}. Le séminaire \versal{XX}. Paris: Seuil, 1975.
\emph{Mais, ainda}. Trad. M. D. Magno. Rio de Janeiro: Zahar, 2008.

\titidem. ``Les non"-dupes errent''. Le séminaire \versal{XXI}, 1973--4 (manuscrito
inédito).

\titidem. \emph{Scilicet}, review of \emph{le champ freudien}, \versal{I"-VII}.
Paris: Seuil, 1968--76.

\titidem. \emph{Ornicar?} \emph{Periodical of le champ freudien}. Dept
of Psycho"-Analysis at Paris \versal{VII} (Vincennes). Paris: le graphe, no. 1 --
1975-. 

\tit{LEMOINE"-LUCCIONI}, Eugénie. \emph{Partage des femmes}, (\emph{le champ freudien}).
Paris: Seuil, 1976.

\tit{MACCABE}, Colin. \emph{The talking cure -- Essays in psychoanalysis and
language}. Londres: Macmillan, 1981.

\tit{MANNONI}, Maud. \emph{L'enfant, sa ``maladie'' et les autres}, (\emph{le champ
freudien}). Paris: Seuil, 1967. \emph{The child, his illness and the
others}. Londres: Tavistock, 1970.

\tit{MONTRELAY}, Michele. ``Recherches sur la femininité''. Em: \emph{Critique}, \versal{XXVI},
Paris, 1970, p. 654--74. Edição revista: ``Inquiry into femininity''.
Trad. e Intro. Parveen Adams. Em: \emph{m/f}, \versal{I}, 1978, p. 65--101.

\tit{RIVIÈRE}, Joan. ``Womanliness as masquerade''. Em: \emph{\versal{IJPA}}, \versal{X}, 1929, p. 303--13.

\tit{RUBIN}, Gayle. ``The Traffic in Women: Notes on the 'Political Economy' of
Sex''. Em: \textsc{reiter}, Rayna R. (ed.). \emph{Toward an Anthropology of
Women}. Monthly Review Press, 1975, p. 157--210.

\tit{SAFOUAN}, Moustapha. \emph{Etudes sur l'\OE dipe}, (\emph{le champ freudien}).
Paris: Seuil, 1974. ``Is the Oedipus complex universal?''. Trad. B. Brewster. Em: \emph{m/f}, 5--6, 1981, p. 83--90.

\tit{SAUSSURE}, Ferdinand de. (1915) \emph{Cours de linguistique générale}. Ed.
Tullio de Mauro. Paris: Payot, 1972. \emph{Course in general
linguistics} (revised ed.). Londres; Fontana, 1974.

\tit{SEGALL}, Hanna. ``Notes os symbol formation''. Em: \emph{\versal{IJPA}}, \versal{XXXVIII}, 1957, p. 391--7.

\tit{STOLLER}, Robert. ``A contribution to the study of gender identity''. Em:
\emph{\versal{IJPA}}, \versal{XLV}, 1965, p. 220--6.

\tit{WINNICOTT}, Donald. (1967) ``Mirror"-role of the mother and family in child
...
\emph{femmes seules}, solteironas e S. Freud}
...
\hedramarkboth{Imposições sexuais e diferenças\ldots{}}{}


\begin{flushright}
\textsc{beatriz santos}\footnote[*]{Psicóloga clínica e psicanalista. Desde 2016 ensina no
Departamento de Estudos Psicanalíticos da Université de Paris (antiga
\emph{Université Paris Diderot}), onde fez mestrado e doutorado. Nos últimos anos tem trabalhado em um campo transdisciplinar incluindo psicanálise, estudos de
gênero e filosofia sobre a questão da violência de gênero e o feminicidio. Co"-dirige a coleção \emph{Figures of the Unconscious} da editora Leuven University Press
e a revista de psicanalise \emph{Research in Psychoanalysis} (França).}
\end{flushright}


\noindent{}Em 1980, a poeta, ensaísta e feminista Adrienne Rich publicou um artigo
...
e homens no tocante ao acesso à autonomia e a posições de poder variadas? No presente artigo, pretendemos examinar este argumento apresentado
por Rich e analisar de que modo esta mesma questão pode ser
...
\section{Diferenças anatômicas,\break consequências psíquicas}
...
Freud, Lacan e Klein.\footnote{Ver \emph{\versal{MLF}. Psychanalyse et politique
...
Vincennes e um dos primeiros tratava da diferença dos sexos (\emph{\versal{MLF}}, 2018, p. 217).\footnote{Entre 1971 e 1972, Antoinette Fouque organizou este seminário
...
requisitos --- mas na verdade sem outra consistência que essa (\versal{PROKHORIS}, 2000, p.~122).
\end{quote}
...
\begin{bibliohedra}
\tit{butler}, Judith; \textsc{david"-ménard}, Monique; \textsc{santos}, Beatriz; \textsc{goulet}, Sarah-Anais Crevier; \textsc{debs}, Nayla; \textsc{polverel}, Elsa. ``Judith Butler et Monique David"-Ménard: d'une autre à l'autre''. Em: \emph{L'Evolution psychiatrique}, 80(2), p.
317--330, 2015.

\tit{fassin}, Éric. ''L'inversion de la question homosexuelle''. Em: \emph{Revue française de psychanalyse}, vol.~67(1), 2003, p.~263--284.

\tit{freud}, Sigmund. ``Quelques conséquences psychiques de la différence
anatomique entre les sexes''. Em: \emph{La vie sexuelle}. Paris: \versal{PUF}, 1925.

\tit{lacan}, Jacques. (1958) ``La direction de la cure et les principes de son pouvoir''. Em:
  \emph{Écrits}. Paris: Le Seuil, 1966, p. 585--645.

\tit{laufer}, Laurie. ``La psychanalyse est"-elle un féminisme manqué?''. Em:
\emph{Nouvelle revue de psychosociologie}, vol.~17, n.~1, 2014, p. 17--29.
  
\tit{mitchell}, Juliet. \emph{Psychanalyse et Féminisme}. Editions Des Femmes, Paris, 1975.

\tit{MLF}. \emph{Psychanalyse et politique 1968--2018: 50 ans de libération des femmes. Volume \versal{I}. Les premières années}. Coletivo, Paris: Editions Des femmes"-Antoinette Fouque, 2018.

\tit{prokhoris}, Sabine. \emph{Le sexe prescrit. La différence sexuelle en
question}. Paris: Flammarion, 2000.

\tit{RICH}, Adrienne. (1980) ``Compulsory Heterosexuality and Lesbian Existence''. Em: \emph{Journal of Women's History}, v.~15, n.~3, p.~11--48, autumn 2003. Traduzido em português como ``Heterossexualidade compulsória e existência lésbica''. Em \emph{Bagoas -- Estudos gays: gêneros e sexualidades}, v.~4, n.~05, 27/11/2012.

\tit{ryan}, Joanna. ``Can psychoanalysis understand homophobia?''. Em: \textsc{dean}, Tim \& \textsc{lance}, Christopher (eds). \emph{Homosexuality and psychoanalysis}. Chicago: University of Chicago Press, 2001, p. 307--321.
\end{bibliohedra}
...
Nancy Fraser ao «lacanismo»\footnote[*]{Partes desse trabalho foram
  ...
  de 2018), na disciplina ``Gênero, identificação e performance: a
  psicanálise em questão'', oferecida por Pedro Ambra e Nelson da Silva
  Jr. (primeiro semestre de 2018, Universidade de São Paulo) e no \versal{XV} Seminário dos Estudantes de Pós"-Graduação em Filosofia da \versal{UFSCar} (setembro de 2019).
  Permanecem nele diversos pontos cegos cujo número, todavia, diminuiu
  devido à generosa leitura e aos ricos comentários de Alessandra Affortunati Martins, João Cunha, Vera Cotrim, Pedro Ambra e Amaro Fleck, a quem
...
\epigraph{(\ldots{}) \emph{notre manque d'imagination dépeuple toujours l'avenir.}}{\textsc{simone de beauvoir}}

\noindent{}Meu objetivo neste capítulo é desenvolver elementos de uma discussão a
...
impasses que perduram ao redor dessa ideia geral. Acredito que o texto
...
reações negativas.\footnote{O contexto geral que alimenta esses
  ...
  1999/2017, 2008/2017. Eles, por sua vez, remetem a todo um sistema de compreensão do que seriam a masculinidade e a feminilidade que se acha extensamente apresentado em \emph{Personas sexuais} (\textsc{paglia}, 1990/1992), compreensão que alega mobilizar a centralização de uma inspiração freudiana e, a meu ver, tem em sua base uma estratégia de naturalização e essencialização de mitos e outras expressões culturais.}
\end{quote}
...
O problema fundamental para a nova geração circunscreve"-se na direção da
...
aos olhos o grande número de mulheres nos grupos terroristas.\footnote{As
  referências da autora são os comandos palestinos, o grupo Baader"-Meinhof
...
ela aborda o problema numa tentativa de centralizar o debate exatamente em Lacan e em Kristeva. Vou me restringir aqui às observações que ela faz a respeito de Lacan.
...
projeto se desenhava ao situar no horizonte uma certa delimitação da nova
...
Fraser continua, todavia, seu argumento, sustentando que, apesar disso ---
...
Esse não é, no entanto, o caso, pensa Fraser, porque o lacanismo está marcado por
...
construção do grafo do desejo, algo que começa a acontecer por volta de
...
limitassem a formulações que Lacan de fato desenvolveu no início dos
...
--- A diferença ``internalizada'',\footnote{Usei esse termo entre aspas
  ...
  psicologista.} trazida para o coração desse sujeito como sua divisão,
...
acerta um alvo central no que diz respeito ao diagnóstico que precisa ser articulado com relação ao problema que é posto aqui. Este alvo é a
circularidade argumentativa envolvida nas noções de falo e de
Nome"-do"-pai. Mas o que quero essencialmente dizer é que ela acerta esse alvo de um modo que talvez possa ser repensado e que, aliás, talvez também nos permita trazer a crítica para um momento interno à própria psicanálise.
...
fazer isso --- então, torna"-se central a necessidade de insistir na
...
\begin{bibliohedra}
\tit{BENVENISTE}, Émile. (1970) ``O aparelho formal da enunciação''. Em:
\emph{Problemas de linguística geral \versal{II}}. Trad. M. A. Escobar. Campinas, \versal{SP}:
Pontes Editores, 2006.

\tit{CORNELL}, Drucila \& \versal{THURSCHWELL}, Adam. ``Feminismo, negatividade,
...
\tit{FRASER}, Nancy. (1985) ``O que é critico na teoria crítica? O argumento
de Habermas e o gênero''. Em: \versal{BENHABIB}, S. \& \versal{CORNELL}, D. (Orgs.)
\emph{Feminismo como crítica da modernidade}. Trad. N. da C. Caixeiro.
Editora Rosa dos tempos, 1987.

\titidem. (2013) ``Contra o `simbolicismo': Usos e abusos do
`lacanismo' para políticas feministas''. Em: \emph{Lacuna: Uma revista
de psicanálise}.  Trad. P. Ambra. São Paulo, n.~4, p.~9, 2017.

\tit{FREUD}, Sigmund. (1905). ``Três ensaios sobre a teoria da sexualidade''.
Em: \emph{Obras completas. Volume 6}. Trad. P. C. de Souza. São Paulo: Companhia das Letras, 2016.

\titidem. (1912--1913) ``Totem e tabu: Algumas concordâncias entre
a vida psíquica dos homens primitivos e dos neuróticos''. Em:
\emph{Obras completas. Volume 11.} Trad. P. C. de Souza. São Paulo:
Companhia das letras, 2012.

\titidem. (1937) ``Análisis terminable e interminable''. Em:
\emph{Obras completas. Volume \versal{23}}. Trad. J. L. Etcheverry. Buenos
Aires: Amorrortu, 2010.

\tit{GALLOP}, Jane. (1988) ``Além do falo''. Em: \emph{Cadernos Pagu}, n.~16, p.
267--287, 2001.

\tit{KRISTEVA}, Julia. (1969) \emph{Introdução à semanálise}. Trad. L. H. F.
Ferraz. São Paulo: Perspectiva, 2012.

\titidem. (1979) ``Women's time''. Trad. A. Jardine, H. Blake. Em:
\emph{Signs}, vol.~7, n.~1,~1981.

\tit{IRIGARAY}, Luce. (1974) ``Ce sexe qui n'en est pas un''. Em: \emph{Ce
sexe qui n'en est pas un}. Paris: Les Éditions de Minuit, 2012.

\tit{LACAN}, Jacques. (1973) ``O aturdito''. Em: \emph{Outros escritos}. Rio de
Janeiro: Zahar, 2003.

\titidem. (1975) \emph{O seminário, livro 20: Mais, ainda}.
{[}1972--1973{]}. Trad. M. D. Magno. Rio de Janeiro: Zahar, 2008.

\titidem. (1991) \emph{O seminário, livro 17: O avesso da
psicanálise}. {[}1969--1970{]}. Trad. M. D. Magno. Rio de Janeiro: Zahar, 1992.

\tit{MARIN}, Inara. ``Déficit psicanalítico na teoria crítica feminista''. Em:
\emph{Dissonâncias}, v.~2, 2018.

\tit{OAKLEY}, Ann. ``A brief history of gender''. Em: \versal{OAKLEY}, Ann \& \versal{MITCHELL},
Juliet. \emph{Who's afraid of feminism? Seeing through the backlash}.
Nova York: The New Press, 1997.

\tit{PAGLIA}, Camille. (1990) \emph{Personas sexuais: Arte e decadência de
Nefertite a Emily Dickinson}. Trad. M Santarrita. São Paulo: Companhia
das letras, 1992.

\titidem. (1991) ``Junk bonds and corporate raiders: Academe in
the hour of the wolf''. Em: \emph{Free Women, free men}. Nova York:
Pantheon, 2017.

\titidem. (1997) ``The modern battle of the sexes''. Em:
\emph{Free Women, free men}. Nova York: Pantheon, 2017.

\titidem. (1999) ``American gender studies today''. Em: \emph{Free
Women, free men}. Nova York: Pantheon, 2017.

\titidem. (2008) ``Feminism past and present: Ideology, action,
and reform''. Em: \emph{Free Women, free men}. Nova York: Pantheon,
2017.

\titidem. ``Mulher deve ser maternal e parar de culpar o homem,
...
\tit{VAN HAUTE}, Philippe \& \versal{GEYSKENS}, Tomas. \emph{Psicanálise sem Édipo? Uma
...
teoria crítica\break e psicanalistas feministas}
...
\begin{flushright}
\textsc{virginia helena ferreira da costa}\footnote[*]{Pesquisadora de Pós"-doutorado (\versal{PNPD-CAPES}) em Filosofia pela Universidade Federal do Espírito Santo (\versal{UFES})
sobre os temas Psicanálise Freudiana, Teoria Crítica e Feminismo. É
organizadora e tradutora do volume \emph{Estudos sobre a Personalidade Autoritária}
da Coleção Adorno (Unesp). É doutora em Filosofia pela Universidade de São
Paulo (\versal{USP}, 2019), com doutorado sanduíche na New School for Social
Research (\versal{NYC}, 2015--2016). Defendeu tese intitulada \emph{`A Personalidade
Autoritária': Antropologia Crítica e Psicanálise}. Possui mestrado em Filosofia
pela Universidade de São Paulo (\versal{USP}, 2014), com mestrado sanduíche na
Universidade Paris \versal{VII} (Paris"-Diderot, 2013). Defendeu dissertação intitulada
\emph{Aspectos das relações interpessoais em Freud: questionamentos morais}. Fez
intercâmbio durante a graduação na Universidade Paris \versal{I} (Sorbonne, 2008"-2009).}
\end{flushright}

\section{Introdução}

\noindent{}Ao longo do desenvolvimento histórico do capitalismo, as funções dos
...
Chodorow que questionam por quê a falência do patriarcalismo familiar
...
indignas'' (\textsc{horkheimer}, 1982, p.~71). Isso ocorria quando havia interesses egoístas e exploratórios na
...
tornaram meras funções das leis inerentes ao seu poder'' (\textsc{horkheimer}, 1982, p.~82). Trata"-se da teoria do declínio da autoridade paterna.
...
progressivamente maior na socialização da criança'' (\textsc{whitebook}, 1996,
p.~138). Assim, a posição
...
trabalho'' (\textsc{horkheimer}, 1982, p.~57). Em outras palavras, a autoridade familiar passou a não mais
...
favorece o autoritarismo e o totalitarismo'' (\textsc{matos}, 1995, p.~176), o que estabeleceria
...
socio"-histórica, tornando"-se apenas um meio de afirmação da esfera
...
externa (\textsc{chodorow}, 1978, p.~189).
\end{quote}
...
coordenadora fora de si mesmo (\textsc{adorno} et al., 1950, p.~234).
\end{quote}
...
violência e ódio inconscientes.\footnote{Ocorreria, nas palavras de
  ...
  que a manipulação substituiu a internalização'' (\textsc{benjamin},
  1977, p. 56). Se
...
opressores'' (\textsc{benjamin}, 1977, p. 54). Ou seja, aspectos da
...
\section{Lasch versus teóricas feministas: uma~crítica~ao~apego~ao~patriarcado}
...
estrutura de personalidade infantil e narcisista'' (\textsc{barrett},
1991, p.~112).
...
selvagens e parecidos com uma guerra'' (\textsc{buhle}, 1998, p.~282--3).
\end{quote}
...
para transmitir aprovação, ao invés de críticas'' (\textsc{barrett},
  1991, p.~114).
  ...
  (\textsc{horkheimer}, 1973, p.~137).\footnote{Em nossa tradução: ``Na crise da família, esta é agora acompanhada pelo acerto de contas não apenas com a opressão brutal que as mulheres mais fracas e, ainda mais, as crianças frequentemente sofriam nas mãos do chefe de família durante as fases iniciais da nova era, mas também com a injustiça econômica na exploração do trabalho doméstico em uma sociedade que, em todos os outros aspectos, obedeceu às leis do mercado.''} Já Adorno, em \emph{Minima
  Moralia}, por exemplo, diz que `` caráter feminino e o ideal da
  ...
  da dominação. Tão má como este'' (\textsc{adorno}, 1992, aforismo 59, p. 84). Para nomes como Jessica Benjamin e
...
nostálgica da autoridade paterna na era da razão'' (\textsc{benjamin},
  1978, p. 48). Nesse âmbito, Jessica Benjamin critica Adorno por
sua persistência ``em ver a internalização como um veículo para a
consciência em vez de uma aceitação inconsciente da
autoridade'' (\textsc{benjamin}, 1977, p. 56).\footnote{``Internalization, even as it
  ...
  individuation underlies them'' (\textsc{benjamin}, 1977, p. 43).}
...
além da elaboração de um diagnóstico crítico aparentemente sem saída. Se
...
reprodução da força de trabalho'' (\textsc{moraes}, 2017, p. 133).
...
pai'' (\textsc{benjamin}, 1978, p. 36). A dominação masculina se torna
...
crítico de questões feministas,\footnote{Concebemos que, ao relacionar à
  ...
  masculinos'' (\textsc{braidotti}, 1989, p. 123). Lembramos ainda que em \emph{Moral sexual
  ...
  inhibición de pensar que se requiere para sofocar lo sexual'' (\textsc{freud},
  1992, p.~177--8).} de outro. Nesse contexto, assumimos o posicionamento de
...
prática podemos encontrar uma desculpa para essa suposição (\textsc{mitchell}, 1974, p. 338--9).
\end{quote}
...
instinto {[}\emph{Trieb}{]} pode alcançar a sua meta'' (\textsc{freud},
  2010, p.~58) de
...
objetivo'' (\textsc{david"-ménard}, 1990, p.~142).
...
objetais'' (\textsc{benjamin}, 1977, p.~47). Assim, tanto para filhas quanto
...
tão importante aspecto'" (\textsc{chodorow}, 1994, p.~8). Assim, o amor anteriormente
...
ambivalente de amor e ódio'' (\textsc{chodorow}, 1994, p.~16). Dentre as
...
ser rejeitado,\footnote{Além disso, a organização assimétrica da
  ...
  or involved with women'' (\textsc{chodorow}, 1989, p.~51).} tendendo a reproduzir socialmente
tal papel.
...
seus pais'' (\textsc{chodorow}, 1978, p.~87--8). Nesse âmbito, o horizonte de modificação social
...
desenvolver em outra ocasião.\footnote{Cf. \textsc{costa}, Virginia Helena
...
alcançada'' (\textsc{rose}, 1986, p.~90--1). Fica, portanto, o desenvolvimento, a ser feito em
...
\begin{bibliohedra}
\tit{adorno}, Theodor W. \emph{Minima
moralia: reflexões a partir da vida danificada}. Lisboa: Edições 70, 1992.

\titidem. ``The problem of a new type of human being'' Em:
\emph{Current of Music: Elements of a radio theory}. Cambrigde: Polity Press, 2009.

\tit{adorno}, Theodor W.; \textsc{levinson}, Daniel J. \& \textsc{sanford}, Nevitt. \emph{The Authoritarian Personality}. \versal{USA}: Harper \& Brothers, Copyright American Jewish Committee,
1950.

\tit{barrett}, Michèle; \textsc{mcintosh}, Mary. \emph{The anti"-social family}.
London/New York: Verso, 1991.

\tit{benjamin}, Jessica. ``Authority and family revisited: or a world
without fathers''. Em: \emph{New German Critique}, no.~13, Special Feminist
Issue, p.~35--57, Winter, 1978.

\titidem. ``The end of internalization: Adorno's social
psychology''. Em: \emph{Telos}, no.~32, p.~42--64, 1977.

\tit{braidotti}, Rosi. ``A política da diferença ontológica''. Em: \textsc{brennan},
Teresa. \emph{Para além do falo}. Rio de Janeiro: Ed. Rosa dos Tempos, 1989.

\tit{buhle}, Mari Jo. \emph{Feminism and its discontents -- a century of
struggle with psychoanalysis}. Cambridge/London: Harvard University Press, 1998.

\tit{chodorow}, Nancy. \emph{Feminism and Psychoanalytic Theory}. New
Haven/London: Yale University Press, 1989.

\titidem. \emph{Feminities, masculinities, sexualities -- Freud
and beyond}. Kentucky: The University Press of Kentucky, 1994.

\titidem. \emph{The reproduction of mothering -- psychoanalysis
and the sociology of gender}. Berkeley/Los Angeles/London: University of
California Press, 1978.

\tit{costa}, Virginia Helena Ferreira da. ``A `sociologização' da
psicanálise em `Dialética do Esclarecimento': sobre Sohn"-Rethel e a
economia pulsional freudiana''. Em: \emph{Dois Pontos}, Curitiba"-São
Carlos, vol.~13, n.~3, dezembro de 2016, p. 251--263.

\tit{david"-Ménard}, Monique. \emph{La folie dans la raison
pure -- Kant lecteur de Swedenborg}. Paris: Librairie J. Vrin, 1990.

\tit{freud}. Sigmund. ``Algunas consecuencias psíquicas de la diferencia
anatómica entre los sexos''. Em: \emph{Obras completas Volumen 19}.
Argentina: Amorrortu editores, 2001.

\titidem. ``El sepultamiento del complejo de Edipo''. Em:
\emph{Obras completas Volumen 19}. Argentina: Amorrortu editores, 2001.

\titidem. \emph{Esquisse d'une psychologie scientifique}.
Toulouse: Éditions Érès, 2011.

\titidem. ``La moral sexual `cultural' y la nerviosidad
Moderna''. Em: \emph{Obras completas Volumen 9}. Argentina: Amorrortu
editores, 1992.

\titidem. ``Nuevas conferencias de Introducción al
psicoanálisis: 33ª. Conferencia: la feminidad''. Em: \emph{Obras
completas Volumen 22}. Argentina: Amorrortu editores, 1992.

\titidem. ``Os instintos e seus destinos''. Em:
\emph{Introdução ao narcisismo, Ensaios de metapsicologia e outros
textos (1914--1916)}. São Paulo: Companhia das Letras, 2010.

\titidem. ``Psicologia das massas e análise do Eu''. Em:
\emph{Psicologia das massas e análise do Eu e outros textos (1920--1923)}.
São Paulo: Companhia das Letras, 2011.

\titidem. ``Sobre la sexualidad femenina''. Em: \emph{Obras
completas Volumen 21}. Argentina: Amorrortu editores, 1992.

\tit{horkheimer}, Max. ``The Family''. Em: \emph{Aspects of Sociology}. London:
Heinemann, 1973.

\titidem. ``Authority and the Family''. Em: \emph{Critical Theory
-- Selected Essays}. New York: Continuum, 1982.

\tit{institut für sozialforschung}. Ed. \emph{Studien über Autorität und
Familie -- Forschungsberichte aus dem Institut für Sozialforschung}.
Lüneburg: zu Klampen Verlag, 1987.

\tit{lasch}, Christopher. \emph{A cultura do narcisismo}. Rio de Janeiro:
Imago, 1983.

\titidem. \emph{Haven in a Heartless World}. New York: W. W.
Norton \& Company, 1995.

\tit{matos}, Olgária. \emph{Os arcanos do inteiramente outro: a Escola de
Frankfurt, a melancolia e a revolução}. São Paulo: Ed. Brasiliense, 1995.

\tit{mitchell}, Juliet. \emph{Psychoanalysis and Feminism -- a radical
reassessment of Freudian psychoanalysis}. New York: Basic Books, 1974.

\tit{mitscherlich}, Alexander. \emph{Society with the Father: A Contribution
to Social Psychology}. Trans. Eric Mosbacher. New York: Harcourt, Brace and World Inc., 1963.

\tit{moraes}, Maria Lygia Quartim de. \emph{Marxismo, psicanálise e
feminismo brasileiro}. Campinas: Unicamp/\versal{IFCH}, 2017.

\tit{rose}, Jacqueline. \emph{Sexuality in the field of vision}. London/New
York: Verso, 1986.

\tit{tort}, Michel. \emph{Fin du dogme paternal}. Malesherbes: Flammarion/Aubier, 2005.

\tit{whitebook}, Joel. \emph{Perversion and utopia -- a study in
psychoanalysis and Critical Theory}. Massachusetts: The \versal{MIT} Press, 1996.
\end{bibliohedra}

\chapter*{Sequelas patriarcalistas em Freud\break segundo Luce Irigaray:
sexualidade\break feminina e diferença sexual}
...
\hedramarkboth{Sequelas patriarcalistas em Freud}{}


\begin{flushright}
\textsc{rafael kalaf cossi}\footnote[*]{Psicanalista; psicólogo, mestre e doutor pela Universidade
de São Paulo (com passagem pela Paris-7); membro do \versal{LATESFIP}
(Laboratório de teoria social, filosofia e psicanálise -- \versal{USP}); autor de \emph{Corpo em
obra} (nVersos, 2011), \emph{Lacan e o feminismo: a diferença dos sexos}
(Annablume, 2018) e organizador de \emph{Faces do sexual: fronteiras entre gênero e
inconsciente} (Aller, 2019).}
\end{flushright}

\noindent{}Neste texto, nos propomos a expor a leitura que Luce Irigaray faz de
...
constituíram um ao outro, como também nunca viveram separados'' (\textsc{dimen}
in \textsc{roth}, 2000, p. 189). Mas não sem conflito, sendo ``como gêmeos que
estivessem, desde o começo, destinados ao amor e à rivalidade
infinitos'' (\textsc{bowlby} in \textsc{brennan}, 1997, p. 66).
...
partir dos anos 60, o ``feminismo das diferenças'' (\textsc{lago}, 2012),
...
estruturas culturais'' (\textsc{cixous} in \textsc{marks}; \textsc{de courtivron}, 1981, p.
249).
...
gramática e linguagem dos homens'' (\textsc{cixous} in \textsc{marks}; \textsc{de courtivron},
...
texto se volta contra si próprio'' (\textsc{grosz}, 1989, p. 33), problematizando
...
Luce Irigaray (1930-) é filósofa, linguista e psicanalista. Em seu
...
adjetivada como ``a filha desobediente da psicanálise'' (\textsc{geerts},
2010/11, p. 1).
...
no \emph{Seminário \versal{XII}} de Lacan --- que, por sinal, ao lado de Leclaire, também
...
Irigaray também integra o \emph{Seminário \versal{XIV}} --- na lição de 1 de fevereiro de
...
A historiadora Lisa Jardine (in \textsc{brennan}, 1997) alega que as mulheres não
...
imaginário feminino alternativo'' (\textsc{jardine} in \textsc{brennan}, 1997, p. 94).
...
a partir do sistema metafísico de Platão, o que acabou achatando o
...
sexo. ``Esse sexo que não é um'',\footnote{\emph{Ce sexe qui n'en est pas
  ...
  \emph{Esse sexo que não é só um sexo: sexualidade e status social da
...
Mas o que ela seria antes dessa `conquista'? ``Nada'' (\textsc{irigaray},
...
tagarelice}; desejo pela mãe/\emph{desejo de ser mãe} (\textsc{irigaray},
...
sociedade masculina (\textsc{irigaray}, 1985, p. 73). Nem a maternidade ---
...
recurso fálico (\textsc{irigaray}, 1985, p. 77--8).
...
tipicamente feminino (\textsc{irigaray}, 1985, p. 114). Contudo, Irigaray
...
mulheres, já que castradas --- aos olhos da menina (\textsc{irigaray}, 1985,
...
cultura ``hommo"-sexual'' (\textsc{irigaray}, 1985, p. 103) dirigida por uma
...
dados com os quais ele estava lidando'' (\textsc{irigaray}, 1985, p. 70).
...
Em ``The mechanics of `fluids'" (1985), Irigaray pondera que toda
...
(\textsc{irigaray}, 1985, p. 229), inabarcável pelos parâmetros
...
(\textsc{irigaray}, 1985, p. 229). Não é infinita, mas também não é uma
...
(\textsc{irigaray}, 1993, p. 41).\footnote{Neste ponto, Bruce Fink se
  ...
  a banda de Moebius, a garrafa de Klein, e o \emph{cross"-cap}'' (\textsc{fink},
...
obscuro, para a explicação da feminilidade (\textsc{freud}, 2010).
...
O grande projeto de Irigaray, afirma Whitford (in \textsc{brennan}, 1997), visa
...
de homem, como um infinito reflexo no espelho (\textsc{irigaray}, 1985, p.
...
articulações sejam embrenhadas de transformações paródicas'' (\textsc{irigaray},
...
(\textsc{irigaray}, 1985, p. 78). A ideia não é criar uma lógica feminina
...
na economia espaço"-temporal da tradição filosófica'' (\textsc{irigaray},
...
sentido, nunca'' (\textsc{irigaray}, 1985, p. 232).
...
mulher, sua experiência de gozo imponderável,\footnote{Irigaray
  comenta a representação do gozo feminino que se dá
  a ver na estátua de Bernini de Santa Teresa, que ilustra a capa do
  \emph{Seminário \versal{XX}} de Lacan: ``Em Roma, tão longe, uma estátua, feita por um
  ...
  homem?'' (1985, p. 91).} na linguagem, e assim convulsionar a sociedade.
...
sintaxe pela qual as mulheres possam se autoafetar'' (\textsc{irigaray},
...
\begin{bibliohedra}
\tit{brennan}, Teresa (Org.). \emph{Para além do falo: uma crítica a Lacan do
ponto de vista da mulher}. Rio de Janeiro: Record/Rosa dos tempos, 1997.

\tit{cixous}, Helene. (1975) ``The laught of the Medusa''. Em: \versal{MARKS}, E.; \versal{DE
COURTIVRON}, I. \emph{New french feminism}. \versal{USA}: Schocken Books, 1981.

\tit{fink}, Bruce. \emph{O sujeito lacaniano: entre a linguagem e o gozo}.
Rio de Janeiro: Jorge Zahar, 1998.

\tit{freud}, Sigmund. (1931). \emph{Sexualidade feminina}. Trad. Paulo César de Souza.
São Paulo: Companhia das letras, volume \versal{XVIII}, 2010.

\tit{gallop}, Jane. \emph{The daughter's seduction -- feminism and
psychoanalysis}. Ithaca: Cornell University Press, 1982.

\tit{geerts}, Evelin. (2010/11) ``Luce Irigaray: the (un)dutiful daughter of
psychoanalysis -- a feminist `moving through and beyond' the
phallogocentric discourse of psychoanalysis''. Disponível em:
\textless{}\emph{https://bit.ly/2kpPOVM}\textgreater{}. Acesso em 29/03/2014.

\tit{grosz}, Elizabeth. \emph{Sexual subversions: three french feminists}.
Austrália: Allen \& Unwin, 1989.

\tit{horney}, Karen. (1967). \emph{Feminine Psychology}. Norton: \versal{NY} \& London, 1993.

\tit{irigaray}, Luce. (1974) \emph{Speculum of the other woman}. Trad. Gillian C.
Gill. Ithaca: Cornell University Press, 1985.

\titidem. (1977) \emph{The sex which is not one}. Trad. Catherine Porter;
Carolyn Burke. Ithaca: Cornell University Press, 1985.

\titidem. (1984) \emph{An ethics of sexual difference}. Trad. Carolyn
Burke \& Gillian C. Gill. Ithaca: Cornell University Press, 1993.

\tit{lago}, Mara Coelho de Souza. (2012) ``A psicanálise nas ondas dos feminismos''.
Disponível em: \textless{}\emph{https://bit.ly/2O42VJ3}\textgreater{}. Acesso em: Recuperado em 27/03/2014.

\tit{preciado}, Beatriz. \emph{Manifiesto contra"-sexual -- prácticas
subversivas de identidad sexual}. Madrid: Editorial Opera Prima, 2002.

\tit{roth}, Michael. \emph{Freud: conflito e cultura: ensaios sobre sua vida,
obra e legado}. Rio de Janeiro: Jorge Zahar, 2000.

\tit{whitford}, Margaret. \emph{The Irigaray reader}. Malden/Oxford: Blackwell
