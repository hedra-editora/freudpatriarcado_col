...
século \versal{XX}'' (1988/1993, p.~38). Segundo a autora, o conceito foi praticamente
...
1986/2005). Esta forclusão de qualquer figuração positiva da mulher
...
de um passo com sérias consequências (\textsc{freud}, 1939/2014, p. 157, grifo
meu).
\end{quote}
...
materno'' (\textsc{freud}, 1916/1996, p. 161) e indica a conexão etimológica das
...
Por mais que se contemporize o embate,\footnote{Essas questões são parte
  ...
  tempo. Cf., por exemplo, \textsc{arán}, M. (2003), \textsc{fraser}, N. (2017),
  \textsc{federici}, S. (2004/2017), \textsc{silveira}, L. (2017).} o maior problema
...
corpo'' (\textsc{preciado}, 2004/2014, p. 29). Para Preciado, ``o gênero é, antes
...
entre o corpo e a alma, a forma e a matéria'' (2004/2014, p.~29).
...
vida.'' (\textsc{goethe}, 1808/2003, p. 195). Verso antológico que, como explica
...
o fundamento, o princípio do complexo de Édipo'' (\textsc{lacan}, 1957-8/1999,
...
filho,\footnote{A título de exemplo, vejamos o que Lacan diz em O
  seminário, livro 17 \emph{O avesso da psicanálise}: ``o papel da mãe é o
      ...
      mãe é isso'' (1969-70/1992, p. 118).} caso a interdição paterna, ``base
de nossa relação com a cultura'' (\textsc{lacan}, 1957-8/1999, p. 180), não o
...
pelo termo \emph{falo}?\footnote{A este respeito cf. \textsc{silveira}, Léa (2017). Disponível em:
...
maior atividade cerebral'' (Ata da reunião de 07 de novembro de 1906/2015).
...
mesmo objeto que ele buscará o gozo {[}\ldots{}{]} (\textsc{aulagnier}, 1961-2/2003,
p. 287-8).
\end{quote}
...
voltas com o ``corpo falante'',\footnote{Cf. \textsc{miller}, J"-A (2016). Disponível em:
...
simbólica}'' (1957-8/1999, p. 274-5), pelo objeto causa do desejo, o objeto fálico.
...
persiste, até certo ponto, por essa via. Lembra Lacan (1969-70/1992, p.~122) que, no enredo mosaico, o lado das mulheres é o da prostituição,
...
disputa Benjamin"-Adorno, já bem esmiuçada na literatura.\footnote{Cf.,
  por exemplo, \textsc{bretas}, A. (2007).} De todo modo, convém insistir no
...
verdade é a irmãzinha do gozo (1969-70/1999, p. 123).
\end{quote}
...
versão primária (\textsc{lacan}, 1969-0/1999, p. 126), por outro lado, é condição
...
como impossível --- não há sujeito do gozo sexual (\textsc{lacan}, 1969-70/1999, p.
...
vislumbrada por Theodor Adorno\footnote{Cf. \textsc{safatle}, Vladimir (2006).} e sua
...
Em outra ocasião,\footnote{Cf. \textsc{parente}, A. 2019.} tentei demonstrar
...
honesto, o capitalista deixa escapar um sorriso de esguelha.\footnote{Na
  ...
  dentro dele'' (\textsc{marx}, 1897/1996, p.~152).} Em outras palavras: na
...
que lhe rende riquezas e o torna capaz de acumulá"-las.\footnote{Deixemos
  ...
  estrume'' (\textsc{marx}, 1897/1996, p. 152). Com essa passagem, o que se vê
  claramente é que nem mesmo o que é tido como resto da civilização
  escapa à lógica do capitalista.}

Em Lacan,\footnote{Cf. \textsc{oliveira}, C. (2008).} a homologia entre o campo
...
abstração inerente à maquinaria capitalista.\footnote{Cf. \textsc{benjamin}, W.
...
definição, algo de instantâneo (\textsc{aulagnier}, 1961-2/2003, p. 282).
\end{quote}
...
\begin{Parskip}
\textsc{Adorno}, T. \emph{Dialética negativa}. Rio de Janeiro: Zahar, 2009.

\textsc{Aran}, M. ``Lacan e o feminine: algumas considerações críticas''. In:
\emph{Revista Natureza Humana}. 5(2): 293-327, jul.-dez. 2003.

São Paulo, 2003

\textsc{Aulagnier}, P. (1961-2) ``Exposição da Sra. Aulagnier: Angústia e
...
\textsc{Benjamin}, W. ``O capitalismo como religião'' In: \emph{O capitalismo
...
\textsc{Bretas}, A. ``Pensar ao mesmo tempo dialética e não"-dialeticamente:
Adorno, leitor de Benjamin''. In: Revista Controvérsia, v. 3, n. 1,
(jan"-jun. de 2007), p. 1-11.

\textsc{Comay}, R. ``Materialist Mutations of the Bilderverbot''. In: Benjamin,
A. Walter Benjamin and Art. London/New York: Continuum, 2005.

\textsc{Federici}, S. (2004) \emph{Calibã e as bruxas}, São Paulo: Editora
Elefante, 2017.

\textsc{Fraser}, N. ``Contra o `simbolicismo': Usos e abusos do `lacanismo' para
políticas feministas''. Em: \emph{Lacuna: Uma revista de psicanálise}.
São Paulo, n. -4, p. 9, 2017.

\textsc{Freud}, S. (1914) \emph{Totem e tabu.} In: Obras completas brasileiras,
...
\textsc{Goethe}, J. W. (1808) \emph{Fausto \versal{I}}. São Paulo: Editora 34, 2013.

\textsc{Harvey}, D. ``O ``novo imperialismo'': ajustes espaço"-temporais e
...
\textsc{Lacan}, J. (1957-8) O seminário, livro 5 \emph{As formações do
...
\textsc{Laurent}, E. ``O corpo falante'' Entrevista com Éric Laurent por Marcus
André Vieira. In; Revista Cult, 211, ano 19, abril de 2016, p. 38-41.

\textsc{Marx}, K. (1897) \emph{O Capital}, v. \versal{I}. In: Coleção \emph{Os
Economistas}. São Paulo: Editora Nova Cultural Ltda, 1996.

\textsc{Miller}, J"-A \emph{O inconsciente e o corpo falante.} In: Apresentação do
...
\textsc{Nunber}, H \& Federn, E. (orgs.) \emph{Atas da Sociedade Psicanalítica de
Viena}. São Paulo: Scriptorium, 2015.

\textsc{Oliveira}, C. ``O chiste, a mais"-valia e o mais"-de"-gozar -- ou o
Capitalismo como piada''. In: Revista Estudos Lacanianos, Belo
Horizonte: \versal{UFMG}/Scriptum Editora, ano \versal{I}, no. 1 (jan"-jun/2008), p.
57-68.

\textsc{Parente}, A. \emph{Freud como grão"-burguês e o patriarcado na
psicanálise.} In: Revista Peixe"-elétrico (no prelo).

\textsc{Preciado}, P. (2004) \emph{Manifesto Contrassexual}. São Paulo: n"-1
Edições, 2014.

\textsc{Ratele}, K. ``Kinky Politics''. In: Arnfred, S. \emph{Re"-thinking
Sexualities in Africa}. Sweden: Almqvist \& Wiksell Tryckeri \versal{AB}, 2004.

\textsc{Safatle}, V. \emph{A paixão do negativo}. São Paulo: \versal{UNESP}/\versal{FAPESP}, 2006.

\textsc{Silveira}, L. ``Assim é a mulher por trás de seu véu? Questionamento
...
\textsc{Viltard}, M. Verbete: Gozo. In: Kaufmann, P., \emph{Dicionário
