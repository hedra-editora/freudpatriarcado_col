...
\chapter*{Dentro do sonho\footnote[*]{Este capítulo é uma adaptação do
  ...
  Masculinidade e psicanálise}. Londres: Routledge, 1994. Tradução de Alexandre Cleaver e revisão de Alessandra Affortunati Martins.}}
\addcontentsline{toc}{chapter}{Dentro do sonho, \footnotesize\emph{por Stephen Frosh}}
\hedramarkboth{Dentro do sonho}{}


\begin{flushright}
\textsc{stephen frosh}\footnote[\dag]{Professor da Birkbeck, University of London desde 1979.
...
\noindent{}Não importa o que se diga sobre diferenças sexuais, a maneira de o dizer
...
torna"-se repletas de expectativas, estereótipos e projeções. Isso,
...
fendas, através das escorregadelas e dos momentos de incerteza da
...
Assim, a superfície da linguagem psicanalítica, igual à linguagem de qualquer
paciente, mascara algo significativo; e esse algo é, ele próprio,
...
Quando fala de diferença sexual, com suas muitas vozes contraditórias, a psicanálise delineia conceitos que ajudam no desafio de
...
sobre seus próprios desejos (1975, p.~132).\footnote{Foi curioso notar que na
  ...
  originalmente citada por Frosh com trad. nossa. [\versal{N.~T.}]}
\end{quote}
...
psicanálise como consequência. A sexualidade aqui é combinada, pois
há tanto o gênio obstinado como o maternal ato de dar à luz; mais
...
psicanalistas ou em sua resposta ao nazismo (\textsc{frosh}, 2005). Forma e
...
Vale a pena explorar em detalhes como o texto trabalha. A
...
relação ao seu patrono provisório e colaborador Josef Breuer
...
``amiga íntima'' de Irma e relembra ``também de ter
...
132).\footnote{Foi curioso notar que na versão brasileira de \emph{A
  ...
  por Frosh com trad. nossa. [\versal{N.~T.}]} Para Lacan, igualmente, o sonho
...
sucintamente neste \emph{Seminário}:
...
partes de seu \emph{Seminário}, Lacan produz o seguinte confronto com o que ele
...
existentes nessa passagem, seu modo de rodear temas como a perda e a
morte \emph{(``essa Matilde por aquela Matilde''}), sua imagética de
horror, que permeia \emph{O seminário} --- essa é uma leitura que ecoa do
...
a reflexão de Lacan sobre a reflexão de Freud do sonho de Irma que
...
eles, mas pela própria natureza das coisas os incorpora ---
são aspectos de sua própria imaginação, criaturas de seu
sonho. Tipicamente, olha dentro da garganta da mulher para encontrar
...
destruição que ocasionou. Contudo, conforme o ego se dissolve e as
...
posições de sujeito, ele é o ponto nodal (o ``\versal{N}''), com escrínios
...
sonhador e objeto. É um texto dedicado ao domínio, por meio do qual
Freud demonstra um controle virtuoso dos princípios de interpretação de
sonhos, banindo, assim, os segredos da noite, bem como as dúvidas de seus
...
obscuro é o feminino --- a natureza, a noite, o continente negro, o sonho.
...
psicanalítica, portanto, feminino em sua forma. Misterioso e obscuro, uma
...
\begin{bibliohedra}
\tit{anzieu}, Didier. (1975) \emph{Freud's Self"-Analysis.} London: Hogarth Press, 1986.

\titidem. (1975) A auto"-análise de Freud. Porto Alegre: Artes Médicas, 1989.

\tit{diller}, Jerry. \emph{Freud's Jewish Identity: A Case Study in the
Impact of Ethnicity}. London: Associated University Presses, 1991.

\tit{freud}, Sigmund. ``The Interpretation of Dreams''. \emph{The Standard
...
\titidem. (1900) \emph{A interpretação dos sonhos}. São Paulo: Companhia das Letras, 2019.

\titidem. ``The Theme of the Three Caskets''. \emph{The Standard
...
\titidem. ``Beyond the Pleasure Principle''. \emph{The Standard
...
\titidem. ``Moses and Monotheism''. \emph{The Standard Edition of the
...
\tit{frosh}, Stephen. \emph{Hate and the Jewish Science: Antisemitism, Nazism
and Psychoanalysis}. London: Palgrave, 2005.

\tit{jones}, Ernest. \emph{Sigmund Freud: Life and Work}. London: Hogarth Press, 1955.

\tit{kristeva}, Julia. \emph{Powers of Horror}. New York: Columbia
University Press, 1980.

\tit{lacan}, Jacques. \emph{The Seminars of Jacques Lacan, Book 2}.
Cambridge: Cambridge University Press, 1955--6.

\titidem. (1955--6) \emph{O seminário, livro 2}. Rio de Janeiro: Zahar, 1985.
\end{bibliohedra}

\chapter*{A origem do destino criado para as mulheres pela psicanálise: por uma leitura reparadora através das atas da Sociedade das Quartas"-feiras}
\addcontentsline{toc}{chapter}{A origem do destino criado para as mulheres pela psicanálise: por uma leitura reparadora através das atas da Sociedade das Quartas"-feiras, \footnotesize\emph{por Aline de Souza Martins e Lívia Santiago Moreira}}
\hedramarkboth{A origem do destino\ldots{}}{}

\begin{flushright}
\textsc{aline de souza martins}\footnote[*]{Doutoranda em Psicologia Clínica (2016--2019) \versal{USP}. Mestre em Psicologia Clinica \versal{USP} (2014). Professora de Psicologia Mackenzie
\versal{SP}. Psicanalista membro do \versal{PsiPOL}, Laboratório de pesquisa e extensão em
Psicanálise, Sociedade e Política e da Redippol.} \\ \textsc{lívia santiago moreira}\footnote[\dag]{Doutoranda em História e Teoria Literária
(\versal{UNICAMP}). Mestre em Psicologia Clínica pelo Instituto de Psicologia da
Universidade de São Paulo (\versal{USP}). Formada em Psicologia pela Universidade
Federal de Minas Gerais(\versal{UFMG}). Especialista em Teoria Psicanalítica pela
Universidade Federal de Minas Gerais(\versal{UFMG}). Professora do Departamento
...
pois eles são, a um tempo, juiz e parte.}{\textsc{simone de beauvoir} citando Poulain de la Barre}

\epigraph{Tudo nesse mundo é sobre sexo exceto sexo. Sexo é sobre poder.}{\textsc{oscar wilde}}

\noindent{}Em seu nascimento, a psicanálise foi criada para compreender e tratar as
patologias cujas origens eram localizadas em questões psíquicas,
e não
na fisiologia corporal. Mas quais seriam os limites de Freud para \linebreak


\noindent{}pensar a relação entre o corpo, o social e o psíquico? Nos registros das reuniões de Freud e seus
...
sexual mais profundo'' (\textsc{federn} \& \textsc{nuremberg}, 1906/2015, p.~63). Adler apresenta um receio sobre a
...
incestuosas'' (1906/2015, p.~65). Poderíamos ler um certo paralelismo na
...
tendendo para explicações ligadas à sexualidade.\footnote{Cf. \textsc{federn} \& \textsc{nuremberg}, 2015, p.~149.}
...
Deve"-se ter em conta fatores sociais?'' (2007/2015, p.~164). Reitler afirma
...
(1907/2015, p.~167). Eitingon parece se irritar e ``declara que sua questão
acerca dos fatores sociais fica enfraquecida se tudo é atribuído à
sexualidade'' (1907/2015, p.~168). Já Stekel diz que ``o mais importante
...
nervosidade dos judeus russos'' (1907/2015, p.~171).
...
``sadomasoquismo''. Wittels acreditava que a análise teria o objetivo e a
...
(1907/2015, p.~265). Wittels, no final da sua apresentação sobre o caráter histérico
da revolucionária russa, ``manifesta, por fim, sua antipatia pessoal por
Leonitiev e por todas as histéricas'' (1907/2015, p.~256). Adler critica a
...
(1907/2015, p.~257). Freud afirma que
...
normalmente são filhas de generais confirma isso (1907/2015, p.~258--259).
\end{quote}
...
anestesia em nossos tempos'' (1908/2015, p.~445). Ao que Freud surpreende com
...
nenhum caso de anestesia sexual em mulheres que exercem o poder (1908/2015, p.~449--450).
\end{quote}
...
a monogamia são, ao menos em teoria, exigências estritas (1908/2015, p. 451).
\end{quote}
...
exercer uma profissão'' (2008/2015, p. 506). E continua, ``os estudos de Marx
...
propriedade'' (2008/2015, p.~506). Por mais inconcebível que possa nos parecer
...
tudo isto que é patológico'' (1910/1967, p.~415). O orador da ocasião fala
...
`femininos' é sentido como masculino'' (1910/1967, p. 415). E ainda:
...
insistente crença na superioridade masculina de origem anatômica, mas
...
por intelectuais leitoras de Freud..
...
Napoleão dizendo que a ``anatomia é o destino'' (2011, p. 211),
...
ela ``saiu perdendo'' (2011, p. 211) --- o que na tradução
...
que explicitamente aparece no Caso Dora (\textsc{freud}, 1905): a solução dos conflitos
...
enfermeiras'' (1907/2015, p. 301). Já Reitler entende que ``a maioria das
mulheres que estuda medicina voluntariamente renunciou aos homens (por
conhecerem seus próprios defeitos físicos)'' (1907/2015, p.~301).
...
estudantes é feia e que as verdadeiras amazonas não têm seios'' (1907/2015,
p. 302). Para Hitschmann:

\begin{quote}
O perigo de ser capturado por um tal ``monstro'', que segundo Wittels,
ameaça os estudantes do sexo masculino, não é tão grande assim, e o
...
preferível à hipocrisia mentirosa de algumas \emph{virgo tacta} (1907/2015, p. 302).
\end{quote}
...
sublimação da sexualidade'' (1907/2015, p. 304). Na sequência lemos nos
...
teóricos clássicos do contrato social, quanto por psicanalistas como Freud. Não
...
\begin{quote}
A dominação dos homens sobre as mulheres e o direito de acesso sexual
...
patriarcal dos homens sobre as mulheres é criado pelo contrato (\textsc{pateman}, 1993, p. 16--17).
\end{quote}
...
século \versal{XX}'' (1993, p.~38). Segundo a autora, o conceito foi praticamente
...
``único conceito que se refere especificamente à sujeição da mulher, e
 ...
 categorias convencionais de análise política'' (\textsc{pateman}, 1993, p.~39).
...
(\textsc{bell hooks}, 2010, p.~1). Levantar a relação entre o patriarcado e o
...
seguir por Pateman (1993) do contrato original. Segundo Freud, a neurose
...
desejos reprimidos do complexo de Édipo'' (\textsc{freud}, 2012, p. 219). Neste
...
castração ---, com a internalização da lei social no \emph{Totem e tabu} (1913), o
...
Pateman (1993). O que sustentava a família patriarcal seria o que ela
...
1993, p. 56) --- o que nos leva a reconhecer na descrição que Freud faz
em seu mito do pai da horda o mesmo processo que os
contratualistas chamam de ``modelo patriarcal da ordem política''.

O sujeito entra na cultura por meio do complexo de Édipo, pois é a primeira vez que as figuras externas são internalizadas no sujeito, tanto representantes da cultura como da política, que ordena o funcionamento dos corpos, como nos diz Stephen Frosh (1987). Quando o menino se
...
Juliet Mitchell foi uma das pioneiras a apontar que a psicanálise
...
o que fica claro na ata do dia 19 de outubro de 1910 (1967),
...
``as meninas se desenvolvem mais rapidamente que os meninos, sentem
 ...
 necessária para o casamento'' (Ata de 12 outubro de 1910/1967, p.~14, tradução nossa).
...
próprio patriarcado e suas consequências. Léa Carneiro Silveira argumenta que as fantasias também podem remeter à história e à
...
cultura seja algo externo à psicanálise'' (no prelo).
...
só pode ser eliminada com a morte'' (1980, p. 166).

Benjamin nos diz que o problema é que quando ser mãe é a principal tarefa social conferida à
...
A desnaturalização do papel da mãe que passa a ser intrinsecamente
...
(2015, p. 304). Mas é possível pensar que essa origem poderia ter sido
...
leitura crítica realizada por psicanalistas mulheres é colocar o
patriarcado em diálogo com o feminismo,
...
Pode"-se dizer que desde a sociedade das Quartas"-feiras (1967,2015), tanto o lugar
...
violentas das histórias de origem que nos formam e tampouco a anatomia.

\begin{bibliohedra}
\tit{beauvoir}, Simone. \emph{O Segundo sexo -- fatos e mitos}. Trad. Sérgio
Milliet. 4 ed. São Paulo: Difusão Européia do Livro, 1980.

\tit{benjamin}, Jessica. ``Beyond Doer and Done to''. \emph{The Psychoanalytic Quarterly}. 73
(1), p.~5--46, 2004.

\titidem. ``The Bonds of Love: Rational Violence and Erotic Domination''. \emph{Feminist Studies}, 6 (1), p. 144--174, 1980.

\titidem. \emph{The bonds of love: psychoanalysis,
feminism, and the problem of domination}. New York: Pantheon books, 1988.

\titidem. \emph{Shadow of the other:
intersubjectivity and gender in psychoanalysis}. New York: Routledge, 1998.

\tit{butler}, Judith. (1990) \emph{Problemas de gênero: feminismo e subversão da
identidade}. Trad. Renato Aguiar. Rio de Janeiro: Civilização Brasileira, 2018.

\titidem. ``Conversando sobre psicanálise: entrevista com Judith
Butler''. Em: \versal{KNUDSEN}, Patrícia Porchat Pereira da Silva. Rev. \emph{Estudos Feministas},
Florianópolis, v. 18, n. 1, p. 161--170, 04/2010. Disponível em:
\textless{}\emph{https://bit.ly/1CI0wqr}\textgreater{}.
Acesso em: 05/03/2019.

\tit{hooks}, bell. (2010) \emph{Understanding patriarchy}. Disponível
em: \textless{}\emph{https://bit.ly/2\\m2cOuE}\textgreater{}. Acesso em: 05/03/2019.

\tit{federn}, Ernst \& \textsc{nuremberg}, Herman (orgs.); \textsc{checchia}, Marcelo; \textsc{torres}, Ronaldo; \textsc{hoffmann},
Waldo (orgs. da ed. brasileira). \emph{Os primeiros psicanalistas: atas da Sociedade Psicanalítica de Viena 1906--1908}, v.~\versal{I}. Trad. Marcella
Marino Medeiros. São Paulo: Scriptorium, 2015.

\tit{federn}, Ernst and \textsc{nuremberg}, Herman (orgs.). \emph{Minutes of the Vienna Psychoanalytic Society (1908--1910)}. v. 2. New York: International University Press, 1967.

\tit{freud}, Sigmund. (1913) ``Totem e tabu''. Em: \emph{Obras Completas Volume 11: Totem
e tabu, Contribuição à história do movimento psicanalítico e outros
textos (1912--1914)}. Trad. Paulo César de Souza. São Paulo: Companhia das Letras, 2012.

\titidem. (1923) ``O Eu e o Id''. Em: \emph{Obras Completas Volume
16: O eu e o id, ``autobiografia'' e outros textos (1923--1925)}. Trad.
Paulo César de Souza. São Paulo: Companhia das Letras, 2011.

\titidem. (1924) ``Dissolução do complexo de Édipo''. Em: \emph{Obras
...
\tit{frosh}, Stephen. \emph{The politics of psychoanalysis: an introduction to
Freudian and Post"-Freudian Theory}. London: Macmillan, 1987.

\titidem. \emph{Psychoanalysis outside the clinic:
interventions in psychosocial Studies}. London: Palgrave macmillan, 2010.

\tit{mitchell}, Juliet. (1974) \emph{Psychoanalysis and feminism: radical
reassessment of freudian psychoanalysis}. England: Penguin, 1990.

\titidem. (1999) ``Introduction''. In: \emph{Psychoanalysis and
feminism: radical reassessment of freudian psychoanalysis}. England: Basic Books, 2000.

\tit{pateman}, Carole. (1988) \emph{O contrato sexual}. Trad. Marta Avancini. Rio
de Janeiro: Paz e Terra, 1993.

\tit{roudinesco}, Elisabeth. \emph{Freud em sua época e no nosso tempo}. Trad.
André Telles. Rio de Janeiro: Zahar, 2016.

\tit{sedgwick}, Eve Kosofsky. ``Paranoid Reading and Reparative Reading, or,
...
\tit{silveira}, Léa Carneiro. ``Sexualidade feminina e herança filogenética:
...
\chapter*{\emph{Bêtes noirs}: as mulheres \emph{queer} da psicanálise\footnote[*]{Taduzido do inglês por Léa Silveira.}}
\addcontentsline{toc}{chapter}{\emph{Bêtes noirs}: as mulheres \emph{queer} da psicanálise, \footnotesize\emph{por Marita Vyrgioti}}
\hedramarkboth{«Bêtes noirs»}{}


\begin{flushright}
\textsc{marita vyrgioti}\footnote[\dag]{Professora associada de estudos psicossociais na Universidade
...
psicanálise em relação à colonialidade. Atualmente pesquisa esses temas
...
Portman \versal{NHS} Foundation Trust, em Londres.}
\end{flushright}
...
How bitterly alone I am.}}{\textsc{melanie klein}, poema escrito em torno de 1920}

\section{Fantasmas «queer»}

\noindent{}O convite para contribuir com um volume sobre \emph{Freud e o
...
sobre a psicanálise. Autoras feministas têm mostrado que, nos
escritos psicanalíticos, a homossexualidade em mulheres é um desejo que
não pode ser teoricamente representado a não ser como um repúdio à diferença \linebreak


\noindent{}sexual e ao sujeito masculino (\textsc{o'connor} e \textsc{ryan}, 1993), como uma regressão
...
``identidade selvagem'' e, se assim for, por que o livro deixa
...
Young"-Bruehl (2008), a relação entre as duas mulheres aparece como algo que
...
a relação entre as duas mulheres é ``como se'' fosse homossexual e, como tal, a possibilidade
...
das lésbicas}''\footnote{Na versão original da biografia escrita por
  ...
  optamos por não seguir a versão da editora Zahar. {[}\versal{N.~T.}{]}}
...
É importante notar que, antes desta passagem, Roudinesco assinala a
...
Anna Freud torna o conceito de ``rendição altruísta'', como retirada em
...
intensidade de suas interações com outras mulheres, incluindo a própria Anna
...
Klára Vágó, fica sob escrutínio (\textsc{grosskurth}, 1986, p. 84--85). De acordo com Grosskurth, as duas mulheres passaram férias de verão em Rosenberg, depois das quais Klein escreveu o poema que consta na epígrafe deste capítulo. A biógrafa de Kelin argumenta que ele teria sido destinado a Vágó, cujo retrato a psicanalista também guardava em seu consultório. Vágó era
divorciada e é descrita como uma ``mulher inteligente, educada e
independente'' (\textsc{flaskay}, 2012, p.~7). Para Grosskurth, foi a criação
...
biografia de Klein, a relação desta com Vágó ocupa apenas algumas páginas
...
\section{Homossexualidade e pele}
...
desejos racializados. O objetivo desta seção, portanto, é duplo: em
...
hierarquias entre colonizador e colonizado, bem como as
...
referência a classes sociais, foram rotuladas como coquetes\footnote{A
  ...
  também carregam subtextos raciais. {[}Não parece ser possível encontrar
  paralelo em português para o primeiro desses termos (\emph{cocotte}),
  já que --- segundo o Houaiss --- ``cocota'' tem o significado de
  ``menina pré"-adolescente e bonita''.{]} [\versal{N.~T.}]} ou ``prostitutas
...
que Anne McClintock (1995) argumenta como sendo a rejeição da diferença sexual
...
\section{Freud interseccional}

No único caso analisado por Freud de uma mulher homossexual, publicado em
...
conclusão bastante rígida e incontestada. Por trás do desejo homosexual da jovem, Freud argumenta que existe uma atitude de desapontamento e ódio para com ambos os pais; uma inveja dos pais --- o casal procriador heterossexual ---, que é a razão pela qual ela teria se afastado tanto dos homens quanto da maternidade. Quando Margarethe compartilhou a
...
``coquete'' e agora de uma ``\emph{cocotte}''\footnote{Optamos por manter o
  termo no original, sem tradução. Cf. nota 4, acima. {[}\versal{N.~T.}{]}}
...
psicanálise e pai de Anna, assim como o pai de sua paciente) a
...
suas expectativas concernentes à continuação da psicanálise. Mas, na
...
\begin{bibliohedra}
\tit{aldrich}, Robert. \emph{Colonialism and Homosexuality}. New York: Routledge, 2003.

\tit{bush}, Barbara. ``Gender and Empire: The Twentieth Century.'' In:
\emph{Gender and Empire}. Edited by Philippa Levine. Oxford: Oxford University Press, 2007, p. 77--111.

\tit{de lauretis}, Teresa. \emph{The Practice of Love: Lesbian Sexuality
and Perverse Desire}. Bloomington and Indianapolis: Indiana University Press, 1994.

\titidem. ``Letter to an Unknown Woman''. In: \emph{That Obscure
...
\tit{flaskay}, Gábor. ``From Patient to Founder of a Psychoanalytic School: Ferenczi’s Influence on the Works of Melanie Klein''. In: \emph{Ferenczi for Our Time: Theory and Practice}. Edited by Judit Szekacs-Weisz and Tom Keve. London: Karnac Books, 2012.

\tit{freud}, Sigmund. ``Three Essays on the Theory of Sexuality''. In:
...
\titidem. ``The Psycho"-Analytic View of Psychogenic Disturbance
...
\titidem. (1912) \emph{The Freud/Jung Letters: The Correspondence
Between Sigmund Freud and C. G. Jung}. Disponível em: \textless{}\emph{https://bit.ly/36IgLHs}\textgreater{}. Acesso em: 15/03/2019.

\titidem. (1920) ``Sobre a psicogênese de um caso de homossexualidade
...
\tit{frosh}, Stephen. \emph{Hate and the Jewish Science: Anti"-Semitism,
Nazism and Psychoanalysis}. 2nd ed. New York: Palgrave Macmillan, 2009.

\titidem. \emph{Hauntings: Psychoanalysis and Ghostly
Transmissions}. Studies in the Psychosocial. \versal{UK}: Palgrave Macmillan, 2013.

\titidem. ``Primitivity and Violence: Traces of the Unconscious
in Psychoanalysis''. In: \emph{Journal of Theoretical and Philosophical
Psychology} 37 (1), 201, p. 37--47.

\tit{fuss}, Diana. \emph{Identification Papers: Readings on
Psychoanalysis, Sexuality, and Culture}. 1st ed. London/New York: Routledge, 1995.

\titidem. ``Fallen Women: `The Psychogenesis of a Case of
...
\tit{gay}, Peter. \emph{Freud: A Life for Our Time}. Revised. New York/London: Norton, 2006.

\tit{gilman}, Sander. ``Black Bodies, White Bodies''. In: \emph{Race,
Writinf and Difference}. Edited by L. Henry and Jr Gates. Chicago:
Chicago University Press, 1986.

\tit{grosskurth}, Phyllis. \emph{Melanie Klein: Her World and Her Work}.
Cambridge \versal{MA}: Harvard University Press, 1986.

\tit{hall}, Radclyffe. \emph{The Well of Loneliness}. New York: Avon Books, 1981.

\tit{klein}, Melanie. ``The Autobiography of Melanie Klein''. Edited by
Janet Sayers and John Forrester. In: \emph{Psychoanalysis and History}, 15, 2013, p. 127--163.

\tit{kristeva}, Julia. ``Melanie Klein''. Translated by Ross
...
\tit{lorde}, Audre. \emph{Zami: A New Spelling of My Name}. Toronto: Crossing Press, 1982.

\tit{mcclintock}, Anne. \emph{Imperial Leather: Race, Gender and
Sexuality in the Colonial Contest}. New York/London: Routledge, 1995.

\tit{o'connor}, Noreen; \textsc{ryan}, joanna. \emph{Wild Desires and Mistaken
Identities: Lesbianism and Psychoanalysis}. London: Virago Press, 1993.

\tit{foster}, RoseMarie Pérez. ``Las Mujeres: Women Speak to the Word of
...
\tit{rose}, Jacqueline. \emph{Why War? Psychoanalysis, Politics, and the
Return to Melanie Klein}. The Bucknell Lectures in Literary Theory.
Oxford \versal{UK} \& Cambridge \versal{USA}: Blackwell Publishers, 1993.

\titidem. \emph{Sexuality in the Field of Vision}. London: Verso, 2005.

\tit{roudinesco}, Elisabeth. \emph{Freud: In His Time and Ours}.
Translated by Catherine Porter. Cambridge \versal{MA}: Harvard University Press, 2016.

\tit{smith}, Jill Suzanne. \emph{Berlin Coquette: Prostitution and the
New German Woman, 1890--1933}. Ithaca/London: Cornell University Press, 2013.

\tit{stewart"-Steinberg}, Suzanne. \emph{Impious Fidelity: Anna Freud,
Psychoanalysis, Politics}. Ithaca/London: Cornell University Press, 2011.

\tit{stoler}, Ann Laura. ``Cultivating Bourgeois Bodies and Racial
...
\tit{worthington}, Anne E. \emph{Female Homosexuality: Psychoanalysis and
Queer Theory}. London: Middlesex University, 2011.

\tit{YOUN-BRUEHL}, Elisabeth. \emph{Anna Freud: A Biography}. 2nd ed. New Haven and London: Yale University Press, 2008.

\end{bibliohedra}

\chapter*{Fricção entre corpo e palavra:\\ crítica ao \emph{Moisés} de Freud e Lacan}
\addcontentsline{toc}{chapter}{Fricção entre corpo e palavra: crítica ao \emph{Moisés} de Freud e Lacan,\\ \footnotesize\emph{por Alessandra Affortunati Martins}}
\hedramarkboth{Fricção entre corpo e palavra}{}

\begin{flushright}
\textsc{alessandra affortunati martins}
\end{flushright}

\epigraph{Em todo traje hei de sentir as penas,\\
...
Com farsas mil da vida obstrui.}{\textsc{goethe}, \emph{Fausto}}

\noindent{}Uma lupa na parte \versal{III} de \emph{O homem Moisés e a religião monoteísta} é
...
a \versal{YHWY} delineiam os traços do povo judeu. Nele, a percepção sensória
...
Em \emph{As formações do inconsciente}, \emph{O seminário 5}, Lacan diz: ``é
...
da ``matéria''? Lacan titubeia em seu \emph{O seminário 7: A ética
...
elaborações psicanalíticas que podem e devem ser ultrapassados. Falo,
...
filho,\footnote{A título de exemplo, vejamos o que Lacan diz em \emph{O
...
nos quartos da Viena \emph{fin"-de"-siècle} --- pecado?
...
\versal{XVIII} de \emph{O seminário, livro 9}: \emph{A identificação}, descreve assim o
obsessivo:
...
\begin{flushright}
\footnotesize
{[}\ldots{}{]} nós {[}psicanalistas{]} sempre nos distinguimos\\
...
acanhados, nas ocasionais fraquezas ou nos possíveis sintomas que
...
%\begin{flushright}
%\footnotesize
\epigraph{a contrassexualidade aponta para a substituição\\
...
e reconhecem os outros corpos como falantes.}{\textsc{paul preciado}}
%\end{flushright}
...
Em seu \emph{O seminário, livro 5}: \emph{As formações do inconsciente}, Lacan
...
Em \emph{O seminário, livro 17}: \emph{O avesso da psicanálise}, voltamos ao
...
efetivamente, esse passo fora da psicanálise.}{\textsc{jacques"-alain miller}}
...
Em outra ocasião,\footnote{Cf. \textsc{parente}, 2019.} tentei demonstrar
...
Ainda na exposição da estrutura fálica e edípica em \emph{O seminário, livro
...
capital} na seção \versal{III}, capítulo \versal{V} ``O trabalho e sua valorização'', na
...
Em Lacan,\footnote{Cf. \textsc{oliveira}, 2008.} a homologia entre o campo
...
Piera Aulagnier em sua fala em \emph{O seminário, livro 9}: \emph{A
identificação}:
...
\begin{bibliohedra}
\tit{adorno}, Theodor. \emph{Dialética negativa}. Rio de Janeiro: Zahar, 2009.

\tit{arán}, Márcia. ``Lacan e o feminine: algumas considerações críticas''. Em:
Revista \emph{Natureza Humana}, São Paulo, 5(2), p. 293--327, jul/dez 2003.

\tit{aulagnier}, Piera. (1961--2) ``Exposição da Sra. Aulagnier: Angústia e
identificação''. Em: Lição \versal{XVIII} de \emph{O seminário, livro 9}: \emph{A
identificação}. Recife: Centro de estudos freudianos do Recife, 2003.

\tit{benjamin}, Walter. ``O capitalismo como religião'' Em: \emph{O capitalismo
como religião.} São Paulo: Boitempo, 2013.

\titidem. (1916) ``Sobre a linguagem em geral e sobre a linguagem
do homem''. Em: \emph{Escritos sobre mito e linguagem}. São Paulo: Editora 34/Duas Cidades, 2011.

\tit{bretas}, Alexia. ``Pensar ao mesmo tempo dialética e não"-dialeticamente:
Adorno, leitor de Benjamin''. Em: Revista \emph{Controvérsia}, v. 3, n. 1, p.~1--11,
jan/jun 2007.

\tit{comay}, Rebecca. ``Materialist Mutations of the Bilderverbot''. In: \textsc{benjamin},
Andrew. \emph{Walter Benjamin and Art}. London/New York: Continuum, 2005.

\tit{checchia}, Marcelo; \textsc{torres}, Ronaldo; \textsc{hoffmann},
Waldo (orgs.). \emph{Atas da Sociedade Psicanalítica de Viena 1906--1908}. Trad. Marcella
Marino Medeiros. São Paulo: Scriptorium, 2015.

\tit{federici}, Silvia. (2004) \emph{O calibã e as bruxas}. São Paulo: Editora Elefante, 2017.

\tit{fraser}, Nancy. ``Contra o `simbolicismo': Usos e abusos do `lacanismo' para
políticas feministas''. Em: \emph{Lacuna: uma revista de psicanálise},
n.~4,~São Paulo, p. 9, 2017.

\tit{freud}, Sigmund. (1914) ``Totem e tabu''. Em: \emph{Obras completas brasileiras}.
Rio de Janeiro: Imago, 1996.

\titidem. (1916) ``\versal{X} Conferência introdutória sobre psicanálise''.
Em:\emph{Obras completas brasileiras}. Rio de Janeiro: Imago, 1996.

\titidem. (1939) \emph{O homem Moisés e a religião monoteísta}.
Porto Alegre: \versal{L\&PM}, 2014.

\tit{goethe}, Johann Wolfgang von. (1808) \emph{Fausto \versal{I}}. São Paulo: Editora 34, 2013.

\tit{harvey}, David. ``O `novo imperialismo': ajustes espaço"-temporais e
acumulação por desapossamento''. Disponível em:
\textless{}\emph{https://bit.ly/2BkmUL3}\textgreater{}.
Acesso em 10/04/2019.

\titidem. ``O `novo imperialismo': acumulação por desapossamento
(Parte \versal{II})''. Disponível em:
\textless{}\emph{https://bit.ly/2kISnma}\textgreater{}.
Acesso em 10/04/2019.

\tit{lacan}, Jacques. (1957--8) \emph{O seminário, livro 5}: \emph{As formações do
inconsciente}. Rio de Janeiro: Zahar, 1999.

\titidem. (1959--60) \emph{O seminário, livro 7}: \emph{A ética da
psicanálise}. Rio de Janeiro: Zahar,1995.

\titidem. (1968--9) \emph{O seminário, livro 16}: \emph{De um Outro ao
outro}. Rio de Janeiro: Zahar, 2008.

\titidem. (1969--70) \emph{O seminário, livro 17}: \emph{O avesso da
psicanálise.} Rio de Janeiro: Zahar, 1992.

\tit{laurent}, Éric. ``O corpo falante''. Entrevista com Éric Laurent por Marcus
André Vieira. Em: Revista \emph{\textsc{cult}}, 211, ano 19, 04/2016, p. 38--41.

\tit{marx}, Karl. (1897) \emph{O Capital, v.~\versal{I}}. Em: Coleção \emph{Os
Economistas}. São Paulo: Editora Nova Cultural Ltda, 1996.

\tit{Miller}, Jacques"-Alain. \emph{O inconsciente e o corpo falante}. Em: Apresentação do
tema do \versal{X} Congresso da \versal{AMP}, no Rio de Janeiro, 2016. Disponível em:
\textless{}\emph{https://bit.ly/2OUbhjW}\textgreater{}. Acesso em 10/04/2019.

\tit{oliveira}, Cláudio. ``O chiste, a mais"-valia e o mais"-de"-gozar -- ou o
Capitalismo como piada''. Em: Revista \emph{Estudos Lacanianos}, Belo
Horizonte: \versal{UFMG}/Scriptum Editora, ano \versal{I}, no. 1, p.~57--68, jan/jun, 2008.

\tit{parente}, Alessandra. ``Freud como grão"-burguês e o patriarcado na
psicanálise''. Em: Revista \emph{Peixe"-elétrico} (no prelo).

\tit{preciado}, Paul. (2004) \emph{Manifesto Contrassexual}. São Paulo: n"-1
edições, 2014.

\tit{ratele}, Kopano. ``Kinky Politics''. In: \textsc{arnfred}, Signe. \emph{Re"-thinking
Sexualities in Africa}. Sweden: Almqvist \& Wiksell Tryckeri \versal{AB}, 2004.

\tit{safatle}, Vladimir. \emph{A paixão do negativo}. São Paulo: \versal{UNESP}/\versal{FAPESP}, 2006.

\tit{silveira}, Léa. ``Assim é a mulher por trás de seu véu? Questionamento
...
\tit{viltard}, Mayette. ``Verbete: Gozo''. Em: \textsc{kaufmann}, Pierre. \emph{Dicionário
