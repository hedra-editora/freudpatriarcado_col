...
\textbf{7) Oswald contra o Patriarcado. Antropofagia, matriarcado e
complexo de Édipo}\footnote{Este texto não teria sido possível sem o
  ...
  projeto); CEDAE (\emph{Centro de Documentação Alexandre Eulálio}) da
  Unicamp; Capes, que através do programa Capes-Cofecub financiou minha
  bolsa de pesquisa na França; IMEC (\emph{Institut Mémoires de
  ...
  Nantes); e Faculdade de Educação da UFRJ, que me concedeu afastamento
...
Freud''.\footnote{ANDRADE, 1970, p.18-19.} Se Freud foi o herói que
...
alguns pontos, divergindo em outros, \footnote{BEAUVOIR, 1976, p.84s.
  ...
  acervo do CEDAE (Unicamp). Nas citações do texto de Oswald, mantenho a
  pontuação adotada pela edição de 1970.} Oswald escreve:

Nenhum sentido (...) teria num regime matriarcal o que os freudistas
...
ligação do fenômeno doméstico de preponderância com o fato fálico. (...)
...
interpretação se deformava, na pauta histórica do Patriarcado. (...)
...
Fenômeno do Patriarcado.\footnote{ANDRADE, 1970, p.125.}
...
muito caiu em descrédito científico.\footnote{Para uma boa exposição e
  análise panorâmica deste debate, ver LYONS \& LYONS, 2004, p.73s. Para
  uma abordagem alternativa, ver KNIGHT, 1991.} Separando o bebê da água
suja do banho, é importante dar crédito a Oswald por ter, em meados do
século XX, percebido a importância de identificar na ``cultura
...
\textbf{Só a antropofagia nos une} \footnote{Primeiro aforisma do
...
que a alma do parente morto não ameace a comunidade.\footnote{MÉTRAUX,
  2013, p.385s; CLASTRES, 2014, p.55s. Ver, ainda, VIVEIROS DE CASTRO,
...
devoração do cativo, ritual extinto já no século XVII, por obra da
...
aliança e predação entre os seres.\footnote{A bibliografia sobre o tema
  é vasta. Destaco BENSUSAN, 2017; DESCOLA, 2005; VIVEIROS DE CASTRO,
  2002, 2015; e CLASTRES, 1972. Em minha tentativa de resumir alguns
...
fantasmagorias.\footnote{Uma recente e significativa produção, acessível
  ...
  desconstruir essa fantasmagoria, da qual destaco KILANI, 2018;
  MONTANARI, 2018; VILLENEUVE, 2016.} Pensar a antropofagia para além da
...
as africanas, asiáticas, orientais...)\footnote{Ver GUILLE-ESCURET,
  2012; MALAMOUD, 1989; e HEUSCH, 1986.} estão fortemente marcadas por
ela, seja no registro mitológico, sobretudo grego;\footnote{DETIENNE \&
  VERNANT, 1979; e DETIENNE, 1977.} seja em dogmas religiosos
...
imagens antropófagas;\footnote{Vale destacar a peça \emph{Pentesiléia,}
  ...
  https://www.pucsp.br/nucleodesubjetividade/Textos/pentesileia\_kleist.pdf}
seja em aspectos insuspeitos da nossa cultura contemporânea;\footnote{Ver
  LÉVI-STRAUSS, 2103.} seja, em especial, na teoria freudiana da
...
tese da universalidade do Complexo de Édipo.\footnote{Ver, além das
  ...
  inéditos e estão disponíveis para consulta no IMEC.}
...
corpo social.\footnote{Ver LÉVI-STRAUSS, 2008, p.463s. Esta definição da
  ...
  infrator ao grupo social (Ver, por exemplo, MELATTI, 1994, p.165-166).
  ...
  Viveiros de Castro em suas obras. Ver, em especial, VIVEIROS DE CASTRO
...
ameríndias.\footnote{Em outro texto, procurei contrastar esta
  ...
  e autodestrutivo. Ver CEPPAS, 2019.}
...
quanto às questões espirituais. \footnote{Há, contudo, um extenso debate
  ...
  GOETTNER-ABENDROTH, 2012, 2009 e 2008; e VAUGHAN, 2007.} Porém, se a
...
luta\emph{,} de denúncia do patriarcado, de negação da universalidade da
...
A ``troca de mulheres'' é (...) um conceito problemático. Quando
...
ela é um pré-requisito da cultura. (...) Entretanto, seria no mínimo uma
...
sistemas de parentesco.\footnote{RUBIN, 1975, p.176.}

Viveiros de Castro, seguindo Lévi-Strauss,\footnote{``...l'ensemble des
  ...
  LÉVI-STRAUSS, 1958, p.68.} argumentou, em texto de 1990, que a ``troca
...
\emph{termo} e \emph{relação}...\footnote{VIVEIROS DE CASTRO 1990, p.26.
  Ver, ainda, VIVEIROS DE CASTRO, 2015, p.144s.}
...
do parentesco}),\footnote{LÉVI-STRAUSS, 1982, p.47s.} ela acaba chegando
...
certos direitos para o homem, outros para a mulher.\footnote{RUBIN,
  1975, p. 177.}
...
do clã. Como argumentou Strathern,\footnote{STRATHERN, 2014.} pensar na
...
e das pessoas nas sociedades tradicionais. \footnote{Strathern analisa
  ...
  segunda metade do século XX. Ver SEEGER, DAMATTA \& VIVEIROS DE
  CASTRO, 1979; e VIVEIROS DE CASTRO 2002, p181s.}
...
particulares e complexos de cada cultura.\footnote{Como Lévi-Strauss
  ...
  indeterminado,~há~formas híbridas~e equívocas.'' LÉVI-STRAUSS, 1982,
...
realizada.\footnote{RUBIN, 1975, p.177. Seguindo a análise de Viveiros
...
vivia.\footnote{RUBIN, 1975, p.168.}
...
de liberdade com que os indígenas vivem a sexualidade.\footnote{O apelo
  ...
  missionários, a etnografia contemporânea (de METRAUX, 2013,
  ps.203-232, a VIVEIROS DE CASTRO, 1986, p.165s, passando por
  LÉVI-STRAUSS, 2008, p.208s, e CLASTRES, 2003, p.118-145) nos oferece
...
biologia.\footnote{Ver KNIGTH, 1991.}

\textbf{Um mito entre outros}
...
acomodar a menos direitos.\footnote{RUBIN, 1975, p.200.}
...
estágios do pensamento: animista, religioso e científico.\footnote{Ver
  GAY, 1989, p.301-311; e GREEN, 1975.} Em \emph{Totem e Tabu}, Freud
...
fins do século XIX e início do século XX.\footnote{Como nota
  Lévi-Strauss, ``o próprio Freud reconhece, com candura, que (...) a
  ...
  LÉVI-STRAUSS, 1986, p.204.} Neste sentido, Freud não peca por adotar
...
enigmáticos.\footnote{LÉVI-STRAUSS, 1958, p.228s.} Lévi-Strauss recusa a
centralidade de Édipo, ou de qualquer outro ``código único e
exclusivo'',\footnote{LÉVI-STRAUSS, 1986, p.231.} assim como a
...
lei.\footnote{O que, evidentemente, não significa que a análise
  ...
  sobre las producciones humanas.'' BILBAO, 2009, p.176-177.}
...
--- que a condição de vivente humano é feminina, portanto''.\footnote{VIVEIROS
...
a ingestão de tabaco...\footnote{Idem, p.257}
...
devir-mulher''.\footnote{DELEUZE \& GUATARRI, 2007, p.32} Para Viveiros
...
real.\footnote{VIVEIROS DE CASTRO, 2015.} E é como um campo de força de
...
masculina.\footnote{DELEUZE \& GUATARRI, 2007, pp. 68s.}

\emph{\textbf{Post scriptum 2}}
...
particularidades da \emph{relação oral canibal}...''.\footnote{GREEN,
...
vela}, pela boca de Abelardo I, que Freud foi o último grande romancista
da burguesia. E essa tirada é um dos maiores elogios que se poderia
fazer ao pai da psicanálise.

\textbf{Bibliografia}

ANDRADE, O. (1970) \emph{Obras completas 6. Do Pau-Brasil à antropofagia
e às utopias}, Rio de Janeiro: Ed. Civilização Brasileira.

BEAUVOIR, S. (1976) \emph{Le deuxième sexe.} Paris: Gallimard.

BENSUSAN, H. (2017) \emph{Linhas de animismo futuro,} Brasília: IEB.

BILBAO, A. (2009) ``Lévi-Strauss y la actitud frente al mundo como
lectura del acontecer: entre psicanálisis y antropología estructural'',
in: BILBAO et al. \emph{Claude Lévi-Strauss en el pensamiento
contemporáneo}, Buenos Aires: Colihue.

CEPPAS. F. (2019) ``Aux marges de l'anthropophagie'', in: LAGEIRA et al.
\emph{Modernidade artística: conexões Brasil-Europa.} (no prelo)

CLASTRES, H. (1972) ``Les beaux-frères ennemis. A propos du cannibalisme
tupinamba.'' in \emph{Nouvelle Revue de Psychanalyse}, nº6, Paris:
Gallimard, p.71-86.

CLASTRES, P. (2014) \emph{Arqueologia da violência}, trad. P. Neves, São
Paulo: Cosac Naify.

CLASTRES, P. (2003) \emph{A sociedade contra o estado}, São Paulo:
Cosacnaif.

DELEUZE, G. \& GUATTARI, F. (2007) \emph{Mil platôs. Capitalismo e
esquizofrenia Vol.4}, São Paulo: ed.34.

DELEUZE, G. \& GUATTARI, F. (2010) \emph{O anti-édipo}, São Paulo:
ed.34.

DESCOLA, P. \emph{Par-delà nature et culture}, Paris: Gallimard.

DETIENNE, M. (1977) \emph{Dionysos mis à mort}, Paris: Gallimard.

DETIENNE, M. \& VERNANT, J-P. (1979) \emph{La cuisine du sacrifice en
pays grec}, Paris: Gallimard.

FREUD, S. (2012) \emph{Totem e Tabu}, trad. P.C. de Souza, São Paulo:
Companhia das Letras.

GAY, P. (1989) \emph{Freud. Uma vida para o nosso tempo}, trad. D.
Bottmann, São Paulo: Cia. das Letras.

GOETTNER-ABENDROTH, H. (2012) \emph{Matriarchal societies. Studies on
indigenous cultures across the globe}, New York: Peter Lang.

GOETTNER-ABENDROTH, H. eds. (2009) \emph{Societies of peace.
...
GREEN, A. (1972) ``Le cannibalisme : réalité ou fantasme agi?'', in
\emph{Nouvelle Revue de Pyschanalyse}, nº6, de 1972, p.27-54.

GUILLE-ESCURET, G. (2012) \emph{Sociologie comparée du cannibalisme,
vol.2 La consommation d'autrui en Asie et en Océanie.} Paris, PUF, 2012.

HEUSCH, L. de (1986) \emph{Le sacrifice dans les religions africaines},
Paris: Gallimard.

KILANI, M. (2018) \emph{Du goût de l'autre. Fragments d'un discours
cannibale}, Paris: Éd. du Seuil.

KNIGHT, C. (1991) \emph{Blood relations. Menstruation and the origins of
culture}. New Haven/London: Yale University Press.

LÉVI-STRAUSS, C. (1958) \emph{Antropologie Estruturale,} Paris: Plon.

LÉVI-STRAUSS, C. (1982) \emph{As estruturas elementares do parentesco},
Petrópolis: Vozes.

LÉVI-STRAUSS,~C.~(2008),~\emph{Tristes Tropiques},~Paris, Gallimard,
Bibliothèque de la Pléiade,~p.463-464.

LÉVI-STRAUSS, C. (1986) \emph{A Oleira Ciumenta}, trad. B.
Perrone-Moisés, São Paulo: Brasiliense.

LÉVI-STRAUSS, C. (2013) \emph{Nous sommes tous de cannibales}, Paris:
Éditions du Seuil.

LYONS, A.P; LYONS, H.D. (2004) \emph{Irregular connections. A history of
anthropology and sexuality.} Lincoln: University of Nebraska Press.

MALAMOUD, C. (1989) \emph{Cuire le monde. Rite et pensée dans l'Inde
ancienne}, Paris: Éd la découverte.

MELATTI, J.C. (1994) \emph{Índios do Brasil}, São Paulo: Hucitec.

MÉTRAUX, A. (2013) \emph{Écrits d'Amazonie. Cosmologies, rituels, guerre
et chamanisme}. Paris: CNRS éditions.

MONTANARI, A. (2018) \emph{Cannibales. Histoire de l'anthropophagie en
Occident}, Paris: Arkhê.

RUBIN, G. (1975) ``Traffic in Women: Notes toward a Political Economy of
Sex'' In: REITER, R. Rapp (ed.).~\emph{Toward an Anthropology of Women}.
New York: Monthly Review Press, p.157-210.

SEEGER, A.; da MATTA, R. \& VIVEIROS DE CASTRO, E. (1979) ``A construção
da pessoa nas sociedades indígenas''. \emph{Boletim do Museu Nacional.
Antropologia} nº 32.

SPIRO, M. (1982) \emph{Oedipus in the Trobiands}, Chicago: Univ. of
Chicago Press.

STRATHERN, M. (2014) \emph{O efeito etnográfico}, São Paulo: Cosacnaif,
p. 109-133.

VAUGHAN, G. (2007) \emph{Women and the gift economy. A radically
different worldview is possible}, Toronto: Inanna Publications.

VILLENEUVE, R. (2016) \emph{Histoire du cannibalisme. De l'anthropologie
rituelle au sadisme sexuel}, Paris: Camion Noir.

VIVEIROS DE CASTRO, E. (1986) \emph{Araweté: os deuses canibais}.~Rio de
Janeiro: Jorge Zahar/Anpocs.

VIVEIROS DE CASTRO, E. (1990) \emph{Princípios e parâmetros: um
comentário a~L'Exercice de la parenté".}~Rio~de Janeiro: Comunicação
do~PPGAS, 17.

VIVEIROS DE CASTRO, E. (2002) \emph{A inconstância da alma selvagem},
São Paulo: Cosacnaif.

VIVEIROS DE CASTRO, E. (2015) \emph{Metafísicas canibais: elementos para
uma antropologia pós-estrutural}, São Paulo: Coasc Naify.

\textbf{8) Escrever: Mulheres, ficção e psicanálise }
...
ficaríamos com raiva. (...) Mas eu tinha ficado com raiva porque ele
...
-- não se pode esperar a \emph{verdade}... Só se pode dar ao público a
...
\begin{quote}
``(...) como tudo começou? Compreende-se que a dualidade dos sexos, como
toda dualidade, tenha sido traduzida por um conflito. (...) Resta
explicar como o homem venceu desde o início. (...) Por que este mundo
...
XIX para o XX, a partir da histeria e do que era dito por cada uma.
...
século V a.C. e, ao longo da história, significações diversas foram
...
compreendida como uma desordem no cérebro. No século XIX, com Charcot,
...
lhe responder, como Sócrates: `'indaga-te a ti mesmo''... pois só o que
...
\begin{quote}
(...) talvez esta seja uma oportunidade de distinguir entre inconsciente
...
\begin{quote}
``(...) a mulher é definida unicamente pelas vias de sua parceria com o
...
ficção é falar da ficção que escrevem sobre elas... Mas também das
ficções que elas mesmas podem escrever.

\textbf{REFERÊNCIAS BIBLIOGRÁFICAS:}

BEAUVOIR, Simone. \emph{O Segundo Sexo. 1. Fatos e Mitos.} Difusão
Européia de Livros. São Paulo, 1970.

BLEICHMAR, Emilce Dio. \emph{O feminismo espontâneo da histeria}.
Editora Artes Médicas, Rio Grande do Sul, 1988.

BREUER J.; FREUD S. \emph{(1893-1895) Estudos sobre a histeria}. In:
Edição Standard Brasileira das Obras Psicológicas Completas de Sigmund
Freud. Rio de Janeiro: Imago, 1996 v. 2.

DESPENTES, Virginie. \emph{Teoria King Kong}. Editora n-1. São Paulo,
2016.

FREUD S. (\emph{1923) A organização genital infantil: uma interpolação
...
\_\_\_\_\_\_\_\_\_, \emph{(1932-1933) Conferência XXXIII Feminilidade.
In:} Edição Standard Brasileira das Obras Psicológicas Completas de
Sigmund Freud. Rio de Janeiro: Imago, 1996 v.22.

KEHL, Maria Rita. \emph{Deslocamentos do Feminino}. Imago. Rio de
Janeiro, 2008

LACAN, Jacques. \emph{Escritos}. Jorge Zahar. Rio de Janeiro, 1995.

MITCHELL, Juliet. \emph{Loucos e Medusas.} Editora Civilização
...
PERROT, Michelle. \emph{As mulheres ou os silêncios da história}. Bauru:
Edusc, 2005.

RUBIN, Gayle. \emph{O Tráfico de Mulheres}. Ubu Editora. São Paulo,
2017.

SOLER, Colette. \emph{O que Lacan dizia sobre as mulheres}. Jorge Zahar.
Rio de Janeiro, 2006.

WOOLF, Virgínia. \emph{Um teto todo seu}. Tordesilhas. São Paulo, 2014.

\textbf{9) Freud e o conhecimento-do-corpo -- viajando pelos limites da
...
\emph{O} \emph{Anti-Édipo} consegue, porém, desafiar muito claramente um
...
diagnóstico psiquiátrico no século XX e para o arranjo psicopolítico do
pós-capitalismo contemporâneo.

\textbf{Um retorno ao Freud dos primórdios}
...
Fliess escritas no século XIX, começando por aquelas conhecidas como
...
109)\footnote{Tendo em vista que as \emph{Primeiras Publicações
  ...
  o original alemão ``{[}...{]} zur Angstneurose aber führen alle
  ...
  Reaktionen ausgibt.'' (Cf.
  \href{https://gutenberg.spiegel.de/buch/kleine-schriften-i-7123/7}{\emph{https://gutenberg.spiegel.de/buch/kleine-schriften-i-7123/7}})
...
angústia, e também oferecer um ponto de partida para o Seminário X de
...
diferenças dos tais atributos. Na Parte I, Proposição V, Espinoza afirma
...
(conforme ele explica em Nota à Proposição X, Parte I ``há apenas uma
...
corpo é um ``modo finito'' de expressão dessa substância (Parte II, Def.
I.). Esse foco em ``valores distintivos'' e, portanto, em um
...
seguinte passagem da Parte I, Definição II: ``Diz-se finita em seu
...
VI, Parte III). Não simplesmente seguir ``sendo'', ou uma
...
sua realidade clínica. Se para Lacan, no Seminário X, a angústia é uma
...
\protect\hypertarget{_Hlk505081139}{}{}Bennett, J. (2010) \emph{Vibrant
Matter: A Political Ecology of Things.} USA: Duke University Press

Bottici, C. (2017) `Bodies in plural: Towards an anarcha-feminist
manifesto',~\emph{Thesis Eleven}, 142(1), pp. 91--111.

Braidotti, R. (2017) \emph{Per Una Politica Affermativa.} Milano:Mimesis
Edizioni

Butler, J. (1997) \emph{The Psychic Life of Power: Theories in
Subjection.} Stanford: Stanford University Press

Cixous, H. (1976) `The Laugh of the Medusa'. \emph{Signs,} Vol. 1, No.
4. (Summer, 1976), pp. 875-893

Curley, E. (1994) \emph{A Spinoza Reader. The Ethics and Other works.
Benedict de} Spinoza (Ed. and Trans. Curley, E.) Princeton, New Jersey:
Princeton University Press

Deleuze, G. and Guattari, F. (1987) \emph{A Thousand Plateaus -
Capitalism and Schizophrenia}. Minneapolis and London: University of
Minnesota Press

Deleuze,G. and Guattari, F. (1983) \emph{Anti-Oedipus - Capitalism and
Schizophrenia.} Minneapolis: University of Minnesota Press

Ettinger, B. (2006) \emph{The Matrixial Borderspace.} USA: University of
Minnesota Press

Freud, S. (1926) `Inhibitions, Symptoms and Anxiety'. \emph{The Standard
Edition of the Complete Psychological Works of Sigmund Freud, Volume XX
(1925- 1926): An Autobiographical Study, Inhibitions, Symptoms and
Anxiety, The Question of Lay Analysis and Other Works}, 75-176

Freud, S. (1917) `Introductory Lectures on Psycho-Analysis'. \emph{The
Standard Edition of the Complete Psychological Works of Sigmund Freud,
Volume XVI (1916 1917): Introductory Lectures on Psycho-Analysis (Part
III)}, 241-463

Freud, S. (1894a) `Draft E. How Anxiety Originates', June 6, 1894.
\emph{The Complete Letters of Sigmund Freud to Wilhelm Fliess,
1887-1904}, 78-83

Freud, S. (1894b) `On The Grounds for Detaching a Particular Syndrome
From Neurasthenia Under The Description `Anxiety Neurosis''. \emph{The
Standard Edition of the Complete Psychological Works of Sigmund Freud,
Volume III (1893-1899): Early Psycho-Analytic Publications}, 85-115

Freud, S. (1892a) `Draft A1 from Extracts From the Fliess Papers'.
\emph{The Standard Edition of the Complete Psychological Works of
Sigmund Freud, Volume I ( 1886-1899): Pre-Psycho-Analytic Publications
and Unpublished Drafts, 177-178}

Freud, S. (1892b) `Draft B from Extracts From the Fliess Papers'.
\emph{The Standard Edition of the Complete Psychological Works of
Sigmund Freud, Volume I ( 1886-1899): Pre-Psycho-Analytic Publications
and Unpublished Drafts, 179-184}

Freud, S. \& Fliess, W. \emph{A correspondência completa de Sigmund
Freud e Wilhelm Fliess 1887-1904}. Rio de Janeiro: Imago, 1986.

Freud, S. (1917) ``Conferências introdutórias''. In: \emph{Obras
completes brasileiras, vol. 13}. São Paulo: Companhia das Letras, 2014.

Grosz, E. (2017) \emph{The Incorporeal: Ontology, Ethics, and the Limits
of Materialism}. New York: Columbia University Press

Grosz, E. (2008) \emph{Chaos, Territory, Art: Deleuze and the Framing of
the Earth}. New York: Columbia University Press

Grosz, E. (2007) `Deleuze, Bergson and the Concept of Life'.~\emph{Revue
internationale de philosophie}, 241(3), 287-300

Guattari, F. (2009) \emph{Chaosophy: Texts and Interviews 1972-1977.}
USA: Semiotext(e)

Guattari, F. (1995) \emph{Chaosmosis. An Ethico-aesthetic paradigm}.
Bloomington and Indianapolis: Indiana University Press

Guattari, F. (1989) \emph{Schizoanalytic Cartographies}. London and
Oxford: Bloomsbury

Guattari, F. and Rolnik, S. (2007) \emph{Molecular Revolution in
Brazil.} USA: Semiotext(e)

Guattari, F. e Rolnik, S. \emph{Cartografias do desejo}. Petrópolis:
Vozes, 1996.

Kordela, K. (2007) \emph{Surplus: Spinoza, Lacan.} USA: SUNY Press

Lacan,J. (2016) \emph{Anxiety. The Seminar of Jacques Lacan Book X} (ed.
Miller, J-A) London:Polity Press

Lacan, J. (1960) The Subversion of the Subject and the Dialectic of
...
Miller,J.A.(\emph{2003)`Lacan's Later Teaching'.Lacanian Ink} Vol.21
Spring.2003 . {[}online{]}
\textless{}\emph{http://www.lacan.com/frameXXI2.htm\textgreater{}}

Mitchell,J. (2000) \emph{Mad Men And Medusas: Reclaiming Hysteria.} UK:
Basic Books

Mitchell, J. (1974) \emph{Psychoanalysis and Feminism}. Oxford:Patheon

Soler, C.(2014) \emph{Lacanian Affects: The Function of Affect in
Lacan's Work.} London:Routledge

Spinoza, B. \emph{Ética.} Belo Horizonte: Autêntica, 2009.

Watson, J. (2011) \emph{Guattari's Diagrammatic Thought. Writing Between
Lacan and Deleuze.} London and Oxford: Bloomsbury

Webster,J. (2018) \emph{Conversion Disorder: Listening to the Body in
Psychoanalysis.} New York: Columbia University Press

Žižek, S. (2010) \emph{Interrogating the Real}. London: Continuum.

Žižek, S. (1992) \emph{Enjoy Your Symptom!.} London:Routledge

Zupančič, A. (2017) \emph{What is Sex?} USA:MIT Press
